...
use Webkul\Cliqnshop\Mail\Customer\SubscriptionNotification;
...
it('returns a successful response', function () {
    // Act and Assert.
    get(route('cliqnshop.home.index'))
        ->assertOk();
});

it('displays the current currency code and channel code', function () {
    // Act
    $response = get(route('cliqnshop.home.index'));
...
it('should returns the search page of the products', function () {
    ...
    // Act and Assert.
    get(route('cliqnshop.search.index', [
...
it('should fails the validation error when provided wrong email address when subscribe to the shop', function () {
    // Act and Assert.
    postJson(route('cliqnshop.subscription.store'))
...
it('should unsubscribe from the shop', function () {
    ...
    // Act and Assert.
    get(route('cliqnshop.subscription.destroy', [
...
it('should store the products to the compare list', function () {
    ...
    postJson(route('cliqnshop.api.compare.store'), [
...
it('should remove product from compare list', function () {
    ...
    deleteJson(route('cliqnshop.api.compare.destroy'), [
        'product_id' => $product->id,
    ])
        ->assertOk()
...
it('should remove all the products from compare list', function () {
    ...
    deleteJson(route('cliqnshop.api.compare.destroy_all'))
        ->assertOk()
