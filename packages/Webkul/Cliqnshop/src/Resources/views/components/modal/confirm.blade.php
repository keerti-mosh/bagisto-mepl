...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "@lang('cliqnshop::app.components.modal.confirm.title')",
                    message = "@lang('cliqnshop::app.components.modal.confirm.message')",
                    options = {
                        btnDisagree: "@lang('cliqnshop::app.components.modal.confirm.disagree-btn')",
                        btnAgree: "@lang('cliqnshop::app.components.modal.confirm.agree-btn')",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
