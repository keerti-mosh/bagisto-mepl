...
<x-shop::products.carousel
    ...
    :src="route('cliqnshop.api.products.index')"
    :navigation-link="route('cliqnshop.home.index')"
/>

<!-- category product listing -->
<x-shop::products.carousel
    title="Men's Collections"
    :src="route('cliqnshop.api.products.index', ['category_id' => 1])"
    :navigation-link="route('cliqnshop.home.index')"
/>
...
<x-shop::products.carousel
    title="Men's Collections"
    :src="route('cliqnshop.api.products.index', ['featured' => 1])"
    :navigation-link="route('cliqnshop.home.index')"
/>
...
<x-shop::products.carousel
    title="Men's Collections"
    :src="route('cliqnshop.api.products.index', ['new' => 1])"
    :navigation-link="route('cliqnshop.home.index')"
/>
...
<x-shop::form action="">
    ...
    <x-shop::form.control-group>
        <x-shop::form.control-group.label>
            @lang('cliqnshop::app.catalog.families.create.column')
        </x-shop::form.control-group.label>
        ...
        <x-shop::form.control-group.control
            ...
            name="column"
            rules="required"
            :label="trans('cliqnshop::app.catalog.families.create.column')"
        >
            <!-- Default Option -->
            <option value="">
                @lang('cliqnshop::app.catalog.families.create.select-group')
            </option>

            <option value="1">
                @lang('cliqnshop::app.catalog.families.create.main-column')
            </option>

            <option value="2">
                @lang('cliqnshop::app.catalog.families.create.right-column')
            </option>
        </x-shop::form.control-group.control>
    ...
    <x-shop::form.control-group>
        ...
        <x-shop::form.control-group.label for="is_unique">
            @lang('cliqnshop::app.catalog.attributes.edit.is-unique')
        </x-shop::form.control-group.label>
    </x-shop::form.control-group>
