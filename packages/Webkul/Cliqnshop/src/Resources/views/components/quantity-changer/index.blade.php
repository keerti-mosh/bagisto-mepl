    ...
    >
        <div>
            <span
                ...
                role="button"
                tabindex="0"
                aria-label="@lang('cliqnshop::app.components.quantity-changer.decrease-quantity')"
                @click="decrease"
            >
            </span>
            ...
            <span
                ...
                role="button"
                tabindex="0"
                aria-label="@lang('cliqnshop::app.components.quantity-changer.increase-quantity')"
                @click="increase"
            >
            </span>
