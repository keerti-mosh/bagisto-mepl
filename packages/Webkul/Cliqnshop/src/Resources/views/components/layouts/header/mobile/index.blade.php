...
<div class="flex flex-wrap gap-4 px-4 pb-4 pt-6 shadow-sm lg:hidden">
    <div class="flex w-full items-center justify-between">
        ...
        <div class="flex items-center gap-x-1.5">
            ...
            <a
                ...
                class="max-h-[30px]"
                aria-label="@lang('cliqnshop::app.components.layouts.header.mobile.bagisto')"
            >
                <img
            ...
            <div class="flex items-center gap-x-5 max-md:gap-x-4">
                ...
                @if($showCompare)
                    <a
                        ...
                        aria-label="@lang('cliqnshop::app.components.layouts.header.mobile.compare')"
                    >
                            ...
                            <x-slot:content>
                                <div class="grid gap-2.5">
                                    <p class="font-dmserif text-xl">
                                        @lang('cliqnshop::app.components.layouts.header.mobile.welcome-guest')
                                    </p>

                                    <p class="text-sm">
                                        @lang('cliqnshop::app.components.layouts.header.mobile.dropdown-text')
                                    </p>
                                </div>
                                ...
                                <div class="mt-6 flex gap-4">
                                    ...
                                    >
                                        @lang('cliqnshop::app.components.layouts.header.mobile.sign-in')
                                    </a>
                                    ...
                                    >
                                        @lang('cliqnshop::app.components.layouts.header.mobile.sign-up')
                                    </a>
                        ...
                        @auth('customer')
                            <x-slot:content class="!p-0">
                                <div class="grid gap-2.5 p-5 pb-0">
                                    <p class="font-dmserif text-xl">
                                        @lang('cliqnshop::app.components.layouts.header.mobile.welcome')’
                                ...
                                <div class="mt-2.5 grid gap-1 pb-2.5">
                                    ...
                                    >
                                        @lang('cliqnshop::app.components.layouts.header.mobile.profile')
                                    </a>
                                    ...
                                    >
                                        @lang('cliqnshop::app.components.layouts.header.mobile.orders')
                                    </a>
                                    ...
                                    @if ($showWishlist)
                                        ...
                                        >
                                            @lang('cliqnshop::app.components.layouts.header.mobile.wishlist')
                                        </a>
                                    @endif
                                    ...
                                    @auth('customer')
                                        ...
                                        >
                                            @lang('cliqnshop::app.components.layouts.header.mobile.logout')
                                        </a>
                                    @endauth
                ...
                <div class="md:hidden">
                    @guest('customer')
                        <a
                            href="{{ route('cliqnshop.customer.session.create') }}"
                            aria-label="@lang('cliqnshop::app.components.layouts.header.mobile.account')"
                        >
                            <span class="icon-users cursor-pointer text-2xl"></span>
                        </a>
                    @endguest
                    ...
                    @auth('customer')
                        <a
                            href="{{ route('cliqnshop.customers.account.index') }}"
                            aria-label="@lang('cliqnshop::app.components.layouts.header.mobile.account')"
                        >
                            <span class="icon-users cursor-pointer text-2xl"></span>
                        </a>
    ...
    <!-- Serach Catalog Form -->
    <form action="{{ route('cliqnshop.search.index') }}" class="flex w-full items-center">
        <label
            for="organic-search"
            class="sr-only"
        >
            @lang('cliqnshop::app.components.layouts.header.mobile.search')
        </label>
        ...
        <div class="relative w-full">
            ...
            <input
                ...
                name="query"
                value="{{ request('query') }}"
                placeholder="@lang('cliqnshop::app.components.layouts.header.mobile.search-text')"
                required
            >
        ...
        >
            ...
            <x-slot:header>
                <div class="flex items-center justify-between">
                    <a href="{{ route('cliqnshop.home.index') }}">
                        <img
                            src="{{ core()->getCurrentChannel()->logo_url ?? bagisto_asset('images/logo.svg') }}"
                            alt="{{ config('app.name') }}"
                            width="131"
                ...
                <div class="border-b border-zinc-200 p-4">
                    <div class="grid grid-cols-[auto_1fr] items-center gap-4 rounded-xl border border-zinc-200 p-2.5">
                        ...
                        @guest('customer')
                            ...
                            >
                                @lang('cliqnshop::app.components.layouts.header.mobile.login')
                    ...
                    <div class="fixed bottom-0 z-10 grid w-full max-w-full grid-cols-[1fr_auto_1fr] items-center justify-items-center border-t border-zinc-200 bg-white px-5 ltr:left-0 rtl:right-0">
                            ...
                            <x-slot:header>
                                <div class="flex items-center justify-between">
                                    <p class="text-lg font-semibold">
                                        @lang('cliqnshop::app.components.layouts.header.mobile.currencies')
                                    </p>
                                </div>
                            </x-slot>
                        ...
                        >
                            ...
                            <x-slot:header>
                                <div class="flex items-center justify-between">
                                    <p class="text-lg font-semibold">
                                        @lang('cliqnshop::app.components.layouts.header.mobile.locales')
                                    </p>
                                </div>
                            </x-slot>
                    ...
                    <div class="border-b border-gray-200 px-6 py-4">
                        ...
                        >
                            ...
                            <div class="text-base font-medium text-black">
                                @lang('cliqnshop::app.components.layouts.header.mobile.back-button')
                            </div>
                        </button>
                    </div>
