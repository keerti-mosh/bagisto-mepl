                ...
                >
                    ...
                    <div class="cookieDesc cookie-consent__message">
                        <p class="mt-2.5 block font-sans text-sm leading-5 text-white">
                            ...
                            >
                                @lang('cliqnshop::app.components.layouts.cookie.index.privacy-policy')
                            </a>
                        </p>
                    </div>
                    ...
                    <div class="cookieButton">
                        <div class="mt-2.5 flex gap-2">
                            <a
                                ...
                                @click="createCookie()"
                            >
                                @lang('cliqnshop::app.components.layouts.cookie.index.accept')
                            </a>
                            ...
                            <a
                                ...
                                @click="rejectCookie()"
                            >
                                @lang('cliqnshop::app.components.layouts.cookie.index.reject')
                            </a>
                        ...
                        <a
                            ...
                            href="{{ route('cliqnshop.customers.gdpr.cookie-consent') }}"
                        >
                            @lang('cliqnshop::app.components.layouts.cookie.index.learn-more-and-customize')
                        </a>
                    </div>
                </div>
            @endif
