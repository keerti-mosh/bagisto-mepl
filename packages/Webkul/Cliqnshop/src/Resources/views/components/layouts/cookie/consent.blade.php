<x-shop::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.components.layouts.cookie.consent.your-cookie-consent-preferences')
    </x-slot>
            ...
            <div class="container mt-8 max-1180:px-5 max-md:mt-6 max-md:px-4">
                <div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
                    ...
                    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                        ...
                        >
                            @lang('cliqnshop::app.components.layouts.cookie.consent.save-and-continue')
                        </button>
                    </div>
                    ...
                    <div class="mt-14 rounded max-sm:mt-8">
                        ...
                        <x-shop::form.control-group class="mb-4 border-b pb-4">
                            <x-shop::form.control-group.label class="font-semibold">
                                @lang('cliqnshop::app.components.layouts.cookie.consent.strictly-necessary')
                        ...
                        @foreach ($cookieConsentKeys as $key => $label)
                            <x-shop::form.control-group class="mb-4 border-b pb-4">
                                <x-shop::form.control-group.label class="font-semibold">
                                    @lang('cliqnshop::app.components.layouts.cookie.consent.' . $label)
                                </x-shop::form.control-group.label>
            ...
            app.component('v-cookie-consent', {
                ...
                methods: {
                    ...
                    saveCookiePreferences() {
                        ...
                        window.location.href = '{{ route('cliqnshop.home.index') }}';
                    },
