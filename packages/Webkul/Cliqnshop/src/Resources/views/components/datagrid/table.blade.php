                ...
                >
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            >
                                @lang('cliqnshop::app.components.datagrid.table.actions')
                            </p>
                        </div>
                    </template>
                </slot>
                    ...
                    <template v-else>
                        ...
                        <template v-else>
                            <div class="row grid border-b border-gray-300 px-4 py-4 text-center text-gray-600">
                                <p>
                                    @lang('cliqnshop::app.components.datagrid.table.no-records-available')
                                </p>
                            </div>
                        </template>
                    </template>
                    ...
                    <template v-else>
                        ...
                        <div v-if="$parent.available.records.length" class="flex items-center justify-between p-6 max-md:p-2">
                            <p class="text-xs font-medium">
                                @{{ "@lang('cliqnshop::app.components.datagrid.table.showing')".replace(':firstItem', $parent.available.meta.from) }}
                                @{{ "@lang('cliqnshop::app.components.datagrid.table.to')".replace(':lastItem', $parent.available.meta.to) }}
                                @{{ "@lang('cliqnshop::app.components.datagrid.table.of')".replace(':total', $parent.available.meta.total) }}
                            </p>
                            ...
                            <nav aria-label="@lang('cliqnshop::app.components.datagrid.table.page-navigation')">
                                <ul class="inline-flex items-center -space-x-px rounded-lg border border-zinc-200 max-md:px-0">
                                    <li  @click="changePage('previous')">
                                        <a
                                            ...
                                            aria-label="@lang('cliqnshop::app.components.datagrid.table.previous-page')"
                                        >
                                    ...
                                    <li>
                                        <input
                                            ...
                                            aria-label="@lang('cliqnshop::app.components.datagrid.table.page-number')"
                                        >
                                    </li>
                                    ...
                                    <li @click="changePage('next')">
                                        <a
                                            href="javascript:void(0);"
                                            class="flex h-10 w-9 items-center justify-center font-medium leading-normal hover:bg-gray-100 max-md:h-8 max-md:w-6 max-md:justify-normal"
                                            aria-label="@lang('cliqnshop::app.components.datagrid.table.next-page')"
                                        >
