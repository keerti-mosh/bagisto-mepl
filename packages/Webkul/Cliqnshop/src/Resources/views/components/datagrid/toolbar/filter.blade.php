                ...
                >
                        ...
                        >
                            <span class="flex items-center justify-between gap-1.5">
                                ...
                                <span class="max-md:hidden">
                                    @lang('cliqnshop::app.components.datagrid.toolbar.filter.title')
                                </span>
                            </span>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:header class="border-b border-zinc-200 !px-4">
                        <p class="text-lg font-semibold">
                            @lang('cliqnshop::app.components.datagrid.toolbar.filter.apply-filter')
                        </p>
                    </x-slot>
                                    ...
                                    <template v-if="column.filterable_type === 'dropdown'">
                                        <div class="flex items-center justify-between">
                                            ...
                                            >
                                                ...
                                                >
                                                    @lang('cliqnshop::app.components.datagrid.toolbar.filter.custom-filters.clear-all')
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <x-shop::dropdown>
                                                <x-slot:toggle>
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            v-text="'@lang('cliqnshop::app.components.datagrid.toolbar.filter.dropdown.select')'"
