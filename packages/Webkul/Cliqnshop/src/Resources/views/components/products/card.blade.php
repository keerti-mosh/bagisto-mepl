    ...
    >
        ...
        >
            <div class="relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
                ...
                <!-- Product Image -->
                <a
                    :href="`{{ route('cliqnshop.product_or_category.index', '') }}/${product.url_key}`"
                ...
                <div class="action-items bg-black">
                    ...
                    >
                        @lang('cliqnshop::app.components.products.card.sale')
                    </p>
                    ...
                    >
                        @lang('cliqnshop::app.components.products.card.new')
                    </p>
                    ...
                    <div class="opacity-0 transition-all duration-300 group-hover:bottom-0 group-hover:opacity-100 max-lg:opacity-100 max-sm:opacity-100">
                        ...
                        @if (core()->getConfigData('customer.settings.wishlist.wishlist_option'))
                            <span
                                ...
                                role="button"
                                aria-label="@lang('cliqnshop::app.components.products.card.add-to-wishlist')"
                                tabindex="0"
                        ...
                        @if (core()->getConfigData('catalog.products.settings.compare_option'))
                            <span
                                ...
                                role="button"
                                aria-label="@lang('cliqnshop::app.components.products.card.add-to-compare')"
                                tabindex="0"
                ...
                <div class="action-items flex items-center justify-between opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 max-md:hidden">
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        ...
                        <button
                            ...
                            @click="addToCart()"
                        >
                            @lang('cliqnshop::app.components.products.card.add-to-cart')
                        </button>
        ...
        >
            <div class="group relative max-h-[258px] max-w-[250px] overflow-hidden">
                ...
                <a :href="`{{ route('cliqnshop.product_or_category.index', '') }}/${product.url_key}`">
                    <x-shop::media.images.lazy
            ...
            <div class="grid content-start gap-4">
                ...
                <p class="text-sm text-zinc-500">
                    <template  v-if="! product.ratings.total">
                        <p class="text-sm text-zinc-500">
                            @lang('cliqnshop::app.components.products.card.review-description')
                        </p>
                    </template>
                ...
                @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                    ...
                    <x-shop::button
                        ...
                        :title="trans('cliqnshop::app.components.products.card.add-to-cart')"
        ...
        app.component('v-product-card', {
            ...
            methods: {
                ...
                addToCompare(productId) {
                    ...
                    if (items.length) {
                        if (! items.includes(productId)) {
                            ...
                            this.$emitter.emit('add-flash', { type: 'success', message: "@lang('cliqnshop::app.components.products.card.add-to-compare-success')" });
                        } else {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('cliqnshop::app.components.products.card.already-in-compare')" });
                        }
                    } else {
                ...
                addToCart() {
                    ...
                    this.$axios.post('{{ route("cliqnshop.api.checkout.cart.store") }}', {
                            'quantity': 1,
                            'product_id': this.product.id,
                        })
                        .then(response => {
