                ...
                <div class="flex items-center justify-between gap-8">
                    ...
                    >
                        <p class="items-center text-xl max-md:text-base max-sm:text-sm">
                            @lang('cliqnshop::app.components.products.carousel.view-all')
                    ...
                    <template v-if="products.length > 3">
                        <span
                            ...
                            role="button"
                            aria-label="@lang('cliqnshop::app.components.products.carousel.previous')"
                            tabindex="0"
                            @click="swipeLeft"
                        >
                        </span>
                        ...
                        <span
                            ...
                            role="button"
                            aria-label="@lang('cliqnshop::app.components.products.carousel.next')"
                            tabindex="0"
                            @click="swipeRight"
                        >
                        </span>
