        ...
        <div>
            <div class="flex items-center gap-4">
                <p class="text-base max-sm:text-sm">
                    @lang('cliqnshop::app.components.range-slider.range')
                </p>
                ...
                <div class="relative h-1 w-full rounded-2xl bg-gray-200">
                    ...
                    <span>
                        <input
                            ...
                            :min="allowedMinRange"
                            :max="allowedMaxRange"
                            aria-label="@lang('cliqnshop::app.components.range-slider.min-range')"
                            @input="handle('min')"
                            @change="change"
                        >
                    </span>
                    ...
                    <span>
                        <input
                            ...
                            :min="allowedMinRange"
                            :max="allowedMaxRange"
                            aria-label="@lang('cliqnshop::app.components.range-slider.max-range')"
                            @input="handle('max')"
                            @change="change"
                        >
                    </span>
