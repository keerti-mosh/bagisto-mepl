<!-- SEO Meta Content -->
@push('meta')
    <meta name="description" content="@lang('cliqnshop::app.compare.title')"/>

    <meta name="keywords" content="@lang('cliqnshop::app.compare.title')"/>
@endPush

<x-shop::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.compare.title')
    </x-slot>
                ...
                <div v-if="! isLoading">
                    <div class="flex items-center justify-between max-md:px-4">
                        ...
                        >
                            ...
                            @lang('cliqnshop::app.compare.delete-all')
                        </div>
                    ...
                    >
                        <img
                            ...
                            alt="@lang('cliqnshop::app.compare.empty-text')"
                        />
                        ...
                        <p
                            ...
                            role="heading"
                        >
                            @lang('cliqnshop::app.compare.empty-text')
                        </p>
                    </div>
                </div>
            ...
            app.component("v-compare", {
                ...
                methods: {
                    getItems() {
                        ...
                        this.$axios.get("{{ route('cliqnshop.api.compare.index') }}", {
                                params: {
                    ...
                    remove(productId) {
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                ...
                                this.$axios.post("{{ route('cliqnshop.api.compare.destroy') }}", {
                                        '_method': 'DELETE',
                        ...
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                if (! this.isCustomer) {
                                    ...
                                    this.$emitter.emit('add-flash', { type: 'success', message:  "@lang('cliqnshop::app.compare.remove-all-success')" });

                                    return;
                                }

                                this.$axios.post("{{ route('cliqnshop.api.compare.destroy_all') }}", {
                                        '_method': 'DELETE',
                                    })
                                    .then(response => {
                                        this.items = [];
