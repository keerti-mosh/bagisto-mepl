@php
    $title = request()->has('query')
            ? trans('cliqnshop::app.search.title', ['query' => request()->query('query')])
            : trans('cliqnshop::app.search.results');
@endphp
...
<x-shop::layouts :has-feature="false">
    ...
    <div class="container px-[60px] max-lg:px-8 max-sm:px-4">
        @if (request()->has('image-search'))
            @include('cliqnshop::search.images.results')
        @endif
        ...
        >
            <div class="container px-[60px] max-lg:px-8 max-sm:px-4">
                <div class="flex items-start gap-10 max-lg:gap-5 md:mt-10">
                    ...
                    @include('cliqnshop::categories.filters')
                    ...
                    <div class="flex-1">
                                ...
                                <template v-else>
                                    <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                                        ...
                                        <p
                                            ...
                                            role="heading"
                                        >
                                            @lang('cliqnshop::app.categories.view.empty')
                                        </p>
                                    </div>
                                </template>
                            </template>
                                ...
                                <template v-if="products.length">
                                    <div class="mt-8 grid grid-cols-3 gap-8 max-1060:grid-cols-2 max-md:mt-5 max-md:justify-items-center max-md:gap-x-4 max-md:gap-y-5">
                                        <x-shop::products.card
                                            ::mode="'grid'"
                                            v-for="product in products"
                                            :navigation-link="route('cliqnshop.search.index')"
                                        />
                                    </div>
                                </template>
                        ...
                        <button
                            ...
                            v-if="links.next"
                        >
                            @lang('cliqnshop::app.categories.view.load-more')
                        </button>
                    </div>
                </div>
            </div>
            ...
            app.component('v-search', {
                ...
                methods: {
                    ...
                    getProducts() {
                        ...
                        this.$axios.get(("{{ route('cliqnshop.api.products.index') }}"), {
