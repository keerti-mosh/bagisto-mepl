<v-image-search>
    <button
        ...
        aria-label="@lang('cliqnshop::app.search.images.index.search')"
    >
    </button>
</v-image-search>
                    ...
                    if (imageInput.files && imageInput.files[0]) {
                        if (imageInput.files[0].type.includes('image/')) {
                            if (imageInput.files[0].size <= 2000000) {
                                ...
                                this.$axios.post('{{ route('cliqnshop.search.upload') }}', formData, {
                                        headers: {
                                    ...
                                    .then(response => {
                                        ...
                                        async function app() {
                                            ...
                                            try {
                                                ...
                                                this.$emitter.emit('add-flash', { type: 'error', message: "@lang('cliqnshop::app.search.images.index.something-went-wrong')"});
                                            }
                                            ...
                                            window.location.href = `${'{{ route('cliqnshop.search.index') }}'}?query=${queryString[0]}&image-search=1`;
                                        }
                                ...
                                this.$emitter.emit('add-flash', { type: 'error', message: '@lang('cliqnshop::app.search.images.index.size-limit-error')'});
                            ...
                            this.$emitter.emit('add-flash', { type: 'error', message: '@lang('cliqnshop::app.search.images.index.only-images-allowed')'});
