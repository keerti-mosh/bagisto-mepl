    ...
    >
        ...
        <x-slot:toggle>
            ...
            >
                ...
                @lang('cliqnshop::app.categories.filters.filter')
            </div>
        </x-slot>
        ...
        <x-slot:header>
            <div class="flex items-center justify-between">
                <p class="text-lg font-semibold">
                    @lang('cliqnshop::app.categories.filters.filters')
                </p>
                ...
                >
                    @lang('cliqnshop::app.categories.filters.clear-all')
                </p>
            </div>
        </x-slot>
    ...
    >
        ...
        <x-slot:toggle>
            ...
            >
                ...
                @lang('cliqnshop::app.categories.filters.sort')
            </div>
        </x-slot>
        ...
        <x-slot:content class="!px-0">
            @include('cliqnshop::categories.toolbar')
        </x-slot>
    </x-shop::drawer>
</div>
...
@pushOnce('scripts')
                    ...
                    >
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="@lang('cliqnshop::app.categories.filters.search.title')"
                                v-model="searchQuery"
                        ...
                        <p
                            ...
                            v-text="
                                '@lang('cliqnshop::app.categories.filters.search.results-info', ['currentCount' => 'currentCount', 'totalCount' => 'totalCount'])'
                    ...
                    <ul class="pb-3 text-base text-gray-700">
                        ...
                        <template v-else>
                            <li
                                ...
                                v-if="! isLoadingMore"
                            >
                                @lang('cliqnshop::app.categories.filters.search.no-options-available')
                            </li>
                    ...
                    <div class="flex justify-center pb-3" v-if="meta && meta.current_page < meta.last_page">
                        ...
                        >
                            <span v-if="isLoadingMore">
                                @lang('cliqnshop::app.categories.filters.search.loading')
                            </span>

                            <span v-else>
                                @lang('cliqnshop::app.categories.filters.search.load-more')
                            </span>
                        </button>
                    </div>
                </template>
    ...
    <script type='module'>
        app.component('v-filters', {
            ...
            methods: {
                getFilters() {
                    this.$axios.get('{{ route("cliqnshop.api.categories.attributes") }}', {
                            params: {
        ...
        app.component('v-filter-item', {
            ...
            methods: {
                ...
                fetchFilterOptions(replace = true) {
                    ...
                    const url = `{{ route("cliqnshop.api.categories.attribute_options", 'attribute_id') }}`.replace('attribute_id', this.filter.id);
        ...
        app.component('v-price-filter', {
            ...
            methods: {
                getMaxPrice() {
                    this.$axios.get('{{ route("cliqnshop.api.categories.max_price", $category->id ?? '') }}')
                        .then((response) => {
                            this.isLoading = false;
