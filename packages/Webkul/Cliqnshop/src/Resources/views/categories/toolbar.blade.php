                ...
                >
                    <x-slot:toggle>
                        ...
                        <button class="flex w-full max-w-[200px] cursor-pointer items-center justify-between gap-4 rounded-lg border border-zinc-200 bg-white p-3.5 text-base transition-all hover:border-gray-400 focus:border-gray-400 max-md:w-[110px] max-md:border-0 max-md:pl-2.5 max-md:pr-2.5">
                            @{{ sortLabel ?? "@lang('cliqnshop::app.products.sort-by.title')" }}
                ...
                <div class="flex items-center gap-10">
                    ...
                    <x-shop::dropdown position="bottom-right">
                        <x-slot:toggle>
                            <!-- Dropdown Toggler -->
                            <button class="flex w-full max-w-[200px] cursor-pointer items-center justify-between gap-4 rounded-lg border border-zinc-200 bg-white p-3.5 text-base transition-all hover:border-gray-400 focus:border-gray-400 max-md:w-[110px] max-md:border-0 max-md:pl-2.5 max-md:pr-2.5">
                                @{{ filters.applied.limit ?? "@lang('cliqnshop::app.categories.toolbar.show')" }}
                    ...
                    <div class="flex items-center gap-5">
                        <span
                            ...
                            role="button"
                            aria-label="@lang('cliqnshop::app.categories.toolbar.list')"
                            tabindex="0"
                        ...
                        <span
                            class="cursor-pointer text-2xl"
                            role="button"
                            aria-label="@lang('cliqnshop::app.categories.toolbar.grid')"
                            tabindex="0"
