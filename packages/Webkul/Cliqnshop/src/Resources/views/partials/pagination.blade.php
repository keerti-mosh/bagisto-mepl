@if ($paginator->hasPages())
    <div class="flex items-center justify-between p-6">
        <p class="text-xs font-medium">
            @lang('cliqnshop::app.partials.pagination.pagination-showing', [
                ...
                <li>
                    ...
                    @else
                        <a
                            ...
                            aria-label="{{ trans('cliqnshop::app.partials.pagination.prev-page') }}"
                        >
                ...
                <li>
                    @if ($paginator->hasMorePages())
                        <a
                            ...
                            aria-label="{{ trans('cliqnshop::app.partials.pagination.next-page') }}"
                        >
