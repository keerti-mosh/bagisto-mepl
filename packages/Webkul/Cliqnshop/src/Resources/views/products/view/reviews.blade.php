                        ...
                        <div class="max-w-[286px]">
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.control
                                    ...
                                    name="attachments"
                                    :label="trans('cliqnshop::app.products.view.reviews.attachments')"
                                    :is-multiple="true"
                                    ref="reviewImages"
                                />
                        ...
                        <div>
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required mt-0">
                                    @lang('cliqnshop::app.products.view.reviews.rating')
                            ...
                            @if (
                                ...
                                <x-shop::form.control-group>
                                    <x-shop::form.control-group.label class="required">
                                        @lang('cliqnshop::app.products.view.reviews.name')
                                    </x-shop::form.control-group.label>
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        rules="required"
                                        :value="old('name')"
                                        :label="trans('cliqnshop::app.products.view.reviews.name')"
                                        :placeholder="trans('cliqnshop::app.products.view.reviews.name')"
                                    />
                            ...
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">
                                    @lang('cliqnshop::app.products.view.reviews.title')
                                </x-shop::form.control-group.label>
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    rules="required"
                                    :value="old('title')"
                                    :label="trans('cliqnshop::app.products.view.reviews.title')"
                                    :placeholder="trans('cliqnshop::app.products.view.reviews.title')"
                                />
                            ...
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">
                                    @lang('cliqnshop::app.products.view.reviews.comment')
                                </x-shop::form.control-group.label>
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    rules="required"
                                    :value="old('comment')"
                                    :label="trans('cliqnshop::app.products.view.reviews.comment')"
                                    :placeholder="trans('cliqnshop::app.products.view.reviews.comment')"
                                    rows="12"
                                />
                            ...
                            <div class="mt-4 flex justify-start gap-4 max-xl:mb-5 max-sm:mb-5 max-sm:flex-wrap max-sm:justify-normal max-sm:gap-x-0">
                                <button
                                    ...
                                    type='submit'
                                >
                                    @lang('cliqnshop::app.products.view.reviews.submit-review')
                                </button>
                                ...
                                >
                                    @lang('cliqnshop::app.products.view.reviews.cancel')
                                </button>
                            </div>
                        </div>
                    </form>
                ...
                <template v-else>
                    <template v-if="reviews.length">
                        <h3 class="mb-8 font-dmserif text-3xl max-md:mb-2.5 max-md:text-2xl max-sm:text-xl">
                            @lang('cliqnshop::app.products.view.reviews.customer-review')
                        ...
                        <div class="flex gap-16 max-lg:flex-wrap max-sm:gap-5 max-sm:gap-x-0">
                            ...
                            <div class="sticky top-24 flex h-max flex-col gap-6 max-lg:relative max-lg:top-auto max-md:w-full">
                                ...
                                <div class="flex flex-col items-center gap-2 max-md:mt-3 max-md:gap-0 max-md:border-b max-md:border-zinc-200 max-md:pb-3">
                                    ...
                                    <p class="text-base text-zinc-500 max-sm:text-sm">
                                        ...
                                        @lang('cliqnshop::app.products.view.reviews.ratings')
                                    </p>
                                </div>
                                ...
                                @if(core()->getConfigData('catalog.products.review.customer_review'))
                                    @if (
                                        ...
                                        >
                                            ...
                                            @lang('cliqnshop::app.products.view.reviews.write-a-review')
                                        </div>
                                    @endif
                                @endif
                            </div>
                            ...
                            <div class="flex w-full flex-col gap-5">
                                ...
                                <button
                                    ...
                                    @click="get()"
                                >
                                    @lang('cliqnshop::app.products.view.reviews.load-more')
                                </button>
                            </div>
                        </div>
                    </template>
                    ...
                    <template v-else>
                        <div class="m-auto grid h-[476px] w-full place-content-center items-center justify-items-center text-center max-md:h-60">
                            ...
                            <p class="text-xl max-md:text-sm max-sm:text-xs">
                                @lang('cliqnshop::app.products.view.reviews.empty-review')
                            </p>
                ...
                @if ((bool) core()->getConfigData('general.magic_ai.review_translation.enabled'))
                    ...
                    >
                        ...
                        <template v-if="isLoading">
                            ...
                            @lang('cliqnshop::app.products.view.reviews.translating')
                        </template>
                        ...
                        <template v-else>
                            ...
                            @lang('cliqnshop::app.products.view.reviews.translate')
                        </template>
                    </button>
                @endif
        ...
        app.component('v-product-reviews', {
            ...
            data() {
                return {
                    ...
                    links: {
                        next: '{{ route('cliqnshop.api.products.reviews.index', $product->id) }}',
                    },
            ...
            methods: {
                ...
                store(params, { resetForm, setErrors }) {
                    ...
                    this.$axios.post('{{ route('cliqnshop.api.products.reviews.store', $product->id) }}', params, {
                            headers: {
                        ...
                        .catch(error => {
                            setErrors({'attachments': ["@lang('cliqnshop::app.products.view.reviews.failed-to-upload')"]});
        ...
        app.component('v-product-review-item', {
            ...
            methods: {
                translate() {
                    ...
                    this.$axios.get("{{ route('cliqnshop.api.products.reviews.translate', ['id' => $product->id, 'review_id' => ':reviewId']) }}".replace(':reviewId', this.review.id))
                        .then(response => {
                            this.isLoading = false;
