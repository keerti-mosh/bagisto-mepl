<div class="grid grid-cols-1 gap-6">
    <div class="flex gap-3">
        ...
        <div class="grid grid-cols-1 gap-1.5 text-sm font-medium">
            <p class="text-[#6E6E6E]">
                @lang('cliqnshop::app.products.view.type.booking.appointment.slot-duration') :
            </p>

            <div>
                @lang('cliqnshop::app.products.view.type.booking.appointment.slot-duration-in-minutes', [
    ...
    <div class="flex gap-3">
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="grid grid-cols-1 gap-1.5 text-sm font-medium">
                <p class="text-[#6E6E6E]">
                    @lang('cliqnshop::app.products.view.type.booking.appointment.today-availability')
                </p>
...
@pushOnce('scripts')
    ...
    >
        <div class="grid w-max select-none gap-3">
            ...
            >
                @lang('cliqnshop::app.products.view.type.booking.appointment.see-details')
            ...
            >
                ...
                <p class="grid gap-y-2.5 text-sm text-gray-600">
                    ...
                    <div v-else>
                        @lang('cliqnshop::app.products.view.type.booking.appointment.closed')
                    </div>
                </p>
            </div>
        </div>
