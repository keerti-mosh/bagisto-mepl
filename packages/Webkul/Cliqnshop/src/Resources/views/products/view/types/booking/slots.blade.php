    ...
    >
        <div>
            <x-shop::form.control-group.label class="required">
                {{ $title  ?? trans('cliqnshop::app.products.view.type.booking.slots.book-an-appointment') }}
            ...
            <div class="grid grid-cols-2 gap-x-4">
                ...
                <x-shop::form.control-group class="!mb-0">
                    <x-shop::form.control-group.label class="hidden">
                        @lang('cliqnshop::app.products.view.type.booking.slots.date')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        name="booking[date]"
                        rules="required"
                        :label="trans('cliqnshop::app.products.view.type.booking.slots.date')"
                ...
                <x-shop::form.control-group class="!mb-0">
                    <x-shop::form.control-group.label class="hidden">
                        @lang('cliqnshop::app.products.view.type.booking.slots.title')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.products.view.type.booking.slots.title')"
                        :placeholder="trans('cliqnshop::app.products.view.type.booking.slots.title')"
                    >
                        <option value="">
                            @lang('cliqnshop::app.products.view.type.booking.slots.select-slot')
                        </option>

                        <option v-if="! slots?.length">
                            @lang('cliqnshop::app.products.view.type.booking.slots.no-slots-available')
                        </option>
