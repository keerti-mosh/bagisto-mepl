<div class="grid grid-cols-1 gap-6">
    <div class="flex gap-3">
        ...
        <div class="grid grid-cols-1 gap-1.5 text-sm font-medium">
            <p class="text-[#6E6E6E]">
                @lang('cliqnshop::app.products.view.type.booking.table.slot-duration') :
            </p>

            <div>
                @lang('cliqnshop::app.products.view.type.booking.table.slot-duration-in-minutes', ['minutes' => $bookingProduct->table_slot->duration])
            </div>
        </div>
    </div>
    ...
    <div class="flex gap-3">
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="grid grid-cols-1 gap-1.5 text-sm font-medium">
                <p class="text-[#6E6E6E]">
                    @lang('cliqnshop::app.products.view.type.booking.table.today-availability')
                </p>
    ...
    @include ('cliqnshop::products.view.types.booking.slots', [
        'bookingProduct' => $bookingProduct,
        'title' => trans('cliqnshop::app.products.view.type.booking.table.book-a-table')
    ])

    <!-- Notes -->
    <x-shop::form.control-group class="!mb-0 w-full">
        <x-shop::form.control-group.label class="required">
            @lang('cliqnshop::app.products.view.type.booking.table.special-notes')
        ...
        <x-shop::form.control-group.control
            ...
            name="booking[note]"
            rules="required"
            :label="trans('cliqnshop::app.products.view.type.booking.table.special-notes')"
            :placeholder="trans('cliqnshop::app.products.view.type.booking.table.special-notes')"
        />
...
@pushOnce('scripts')
    ...
    >
        <div class="grid w-max select-none gap-3">
            ...
            >
                @lang('cliqnshop::app.products.view.type.booking.table.slots-for-all-days')
            ...
            >
                ...
                <p class="text-sm text-gray-600">
                    ...
                    <div v-else>
                        @lang('cliqnshop::app.products.view.type.booking.table.closed')
                    </div>
                </p>
            </div>
        </div>
