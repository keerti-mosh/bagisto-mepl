        ...
        <div class="grid grid-cols-1 gap-2.5">
            <template v-if="renting_type == 'daily_hourly'">
                <x-shop::form.control-group.label class="required w-full">
                    @lang('cliqnshop::app.products.view.type.booking.rental.choose-rent-option')
                ...
                <div class="mb-3 grid grid-cols-2 gap-2.5">
                    ...
                    <span class="flex gap-x-4">
                        ...
                        <label
                            ...
                            for="booking[daily]"
                        >
                            @lang('cliqnshop::app.products.view.type.booking.rental.daily-basis')
                        </label>
                    </span>
                    ...
                    <span class="flex gap-x-4">
                        ...
                        <label
                            ...
                            for="booking[hourly]"
                        >
                            @lang('cliqnshop::app.products.view.type.booking.rental.hourly-basis')
                        </label>
                    </span>
                </div>
            </template>
            ...
            <div class="flex flex-col gap-2.5" v-if="renting_type != 'daily' && sub_renting_type == 'hourly'">
                <div  class="grid gap-1.5">
                    <label class="required">
                        @lang('cliqnshop::app.products.view.type.booking.rental.select-slot')
                    </label>
                    ...
                    <div class="flex gap-2.5">
                        ...
                        <x-shop::form.control-group class="!mb-0 w-full">
                            <x-shop::form.control-group.label class="hidden">
                                @lang('cliqnshop::app.products.view.type.booking.rental.select-date')
                            </x-shop::form.control-group.label>
                            ...
                            <x-shop::form.control-group.control
                                ...
                                rules="required"
                                :label="trans('cliqnshop::app.products.view.type.booking.rental.select-date')"
                                :placeholder="trans('cliqnshop::app.products.view.type.booking.rental.select-date')"
                                data-min-date="today"
                        ...
                        <x-shop::form.control-group class="!mb-0 w-full">
                            ...
                            >
                                ...
                                <option v-if="! slots?.length">
                                    @lang('cliqnshop::app.products.view.type.booking.rental.no-slots-available')
                                </option>
                ...
                >
                    <label class="required">
                        @lang('cliqnshop::app.products.view.type.booking.rental.select-rent-time')
                    </label>
                    ...
                    <div class="flex gap-2.5">
                        ...
                        <x-shop::form.control-group class="!mb-0 w-full">
                            ...
                            >
                                <option value="">
                                    @lang('cliqnshop::app.products.view.type.booking.rental.select-time-slot')
                                </option>
                        ...
                        <x-shop::form.control-group class="!mb-0 w-full">
                            <x-shop::form.control-group.label class="hidden">
                                @lang('cliqnshop::app.products.view.type.booking.rental.slot')
                            </x-shop::form.control-group.label>
                            ...
                            <x-shop::form.control-group.control
                                ...
                                rules="required"
                                :label="trans('cliqnshop::app.products.view.type.booking.rental.slot')"
                                :placeholder="trans('cliqnshop::app.products.view.type.booking.rental.slot')"
                            >
                                <option value="">
                                    @lang('cliqnshop::app.products.view.type.booking.rental.select-time-slot')
                                </option>
            ...
            <div v-else>
                ...
                <div class="flex gap-2.5">
                    ...
                    <x-shop::form.control-group class="!mb-0 w-full">
                        <x-shop::form.control-group.label class="hidden">
                            @lang('cliqnshop::app.products.view.type.booking.rental.from')
                        </x-shop::form.control-group.label>
                        ...
                        <x-shop::form.control-group.control
                            ...
                            rules="required"
                            :label="trans('cliqnshop::app.products.view.type.booking.rental.from')"
                            :placeholder="trans('cliqnshop::app.products.view.type.booking.rental.from')"
                            data-min-date="today"
                            @change="dateSelected($event)"
                        />
                    ...
                    <x-shop::form.control-group class="!mb-0 w-full">
                        <x-shop::form.control-group.label class="hidden">
                            @lang('cliqnshop::app.products.view.type.booking.rental.to')
                        </x-shop::form.control-group.label>
                        ...
                        <x-shop::form.control-group.control
                            ...
                            rules="required"
                            :label="trans('cliqnshop::app.products.view.type.booking.rental.to')"
                            :placeholder="trans('cliqnshop::app.products.view.type.booking.rental.to')"
                            data-min-date="today"
                            @change="dateSelected($event)"
                        />
        ...
        app.component('v-rental-slots', {
            ...
            methods: {
                dateSelected(params) {
                    ...
                    this.$axios.get(`{{ route('cliqnshop.booking-product.slots.index', '') }}/${this.bookingProduct.id}`, {
                        params: { date }
                    })
                        .then((response) => {
                            this.selected_slot = '';
