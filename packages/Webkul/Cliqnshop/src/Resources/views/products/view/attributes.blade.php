...
@if ($customAttributeValues = $productViewHelper->getAdditionalData($product))
    <accordian
        :title="trans('cliqnshop::app.products.specification')"
        :active="false"
    >
        <div slot="header">
            @lang('cliqnshop::app.products.specification')
                ...
                @foreach ($customAttributeValues as $attribute)
                    <tr>
                        ...
                        @if (
                            ...
                            <td>
                                <a href="{{ route('cliqnshop.product.file.download', [$product->id, $attribute['id']])}}">
