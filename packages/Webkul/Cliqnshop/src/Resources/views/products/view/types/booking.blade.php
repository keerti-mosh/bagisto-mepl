        ...
        >
            <div class="mt-6 grid w-full max-w-[470px] grid-cols-1 gap-6">
                @if ($bookingProduct->location)
                    <div class="flex gap-4">
                        ...
                        <div class="grid grid-cols-1 gap-1.5 text-sm font-medium">
                            <p>
                                @lang('cliqnshop::app.products.view.type.booking.location')
                            </p>
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                ...
                                >
                                    @lang('cliqnshop::app.products.view.type.booking.view-on-map')
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full max-w-[470px]">
                    @include ('cliqnshop::products.view.types.booking.' . $bookingProduct->type, ['bookingProduct' => $bookingProduct])
                </div>
            </div>
        </script>
