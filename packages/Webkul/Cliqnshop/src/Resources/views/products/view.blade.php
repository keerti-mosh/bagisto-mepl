...
@push('meta')
    ...
    <meta property="og:url" content="{{ route('cliqnshop.product_or_category.index', $product->url_key) }}" />
@endPush
...
<x-shop::layouts>
        ...
        <div class="max-1180:hidden">
            ...
            >
                ...
                <x-shop::tabs.item
                    ...
                    :title="trans('cliqnshop::app.products.view.description')"
                    :is-selected="true"
                >
                ...
                @if(count($attributeData))
                    <x-shop::tabs.item
                        id="information-tab"
                        class="container mt-[60px] !p-0"
                        :title="trans('cliqnshop::app.products.view.additional-information')"
                        :is-selected="false"
                    >
                        <div class="container mt-[60px] max-1180:px-5">
                ...
                <x-shop::tabs.item
                    id="review-tab"
                    class="container mt-[60px] !p-0"
                    :title="trans('cliqnshop::app.products.view.review')"
                    :is-selected="false"
                >
                    @include('cliqnshop::products.view.reviews')
                </x-shop::tabs.item>
            </x-shop::tabs>
        </div>
    </div>
    ...
    <div class="container mt-6 grid gap-3 !p-0 max-1180:px-5 1180:hidden">
        ...
        >
            <x-slot:header class="bg-gray-100 max-md:!py-3 max-sm:!py-2">
                <p class="text-base font-medium 1180:hidden">
                    @lang('cliqnshop::app.products.view.description')
                </p>
            </x-slot>
        ...
        @if (count($attributeData))
            ...
            >
                <x-slot:header class="bg-gray-100 max-md:!py-3 max-sm:!py-2">
                    <p class="text-base font-medium 1180:hidden">
                        @lang('cliqnshop::app.products.view.additional-information')
                    </p>
                </x-slot>
        ...
        >
            ...
            >
                <p class="text-base font-medium">
                    @lang('cliqnshop::app.products.view.review')
                </p>
            </x-slot>
    ...
    <x-shop::products.carousel
        :title="trans('cliqnshop::app.products.view.related-product-title')"
        :src="route('cliqnshop.api.products.related.index', ['id' => $product->id])"
    />

    <!-- Up-sell Products -->
    <x-shop::products.carousel
        :title="trans('cliqnshop::app.products.view.up-sell-title')"
        :src="route('cliqnshop.api.products.up-sell.index', ['id' => $product->id])"
    />
                ...
                >
                    ...
                    <div class="container px-[60px] max-1180:px-0">
                        <div class="mt-12 flex gap-9 max-1180:flex-wrap max-lg:mt-0 max-sm:gap-y-4">
                            ...
                            @include('cliqnshop::products.view.gallery')
                            ...
                            <div class="relative max-w-[590px] max-1180:w-full max-1180:max-w-full max-1180:px-5 max-sm:px-4">
                                ...
                                <div class="flex justify-between gap-4">
                                    ...
                                    @if (core()->getConfigData('customer.settings.wishlist.wishlist_option'))
                                        <div
                                            ...
                                            role="button"
                                            aria-label="@lang('cliqnshop::app.products.view.add-to-wishlist')"
                                            tabindex="0"
                                ...
                                @if (\Webkul\Tax\Facades\Tax::isInclusiveTaxProductPrices())
                                    <span class="text-sm font-normal text-zinc-500 max-sm:text-xs">
                                        (@lang('cliqnshop::app.products.view.tax-inclusive'))
                                    </span>
                                @endif
                                ...
                                @include('cliqnshop::products.view.types.simple')

                                @include('cliqnshop::products.view.types.configurable')

                                @include('cliqnshop::products.view.types.grouped')

                                @include('cliqnshop::products.view.types.bundle')

                                @include('cliqnshop::products.view.types.downloadable')

                                @include('cliqnshop::products.view.types.booking')
                                ...
                                <div class="mt-8 flex max-w-[470px] gap-4 max-sm:mt-4">
                                    ...
                                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                        ...
                                        <x-shop::button
                                            ...
                                            :loading="false"
                                            :title="trans('cliqnshop::app.products.view.add-to-cart')"
                                ...
                                @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                    ...
                                    @if (core()->getConfigData('catalog.products.storefront.buy_now_button_display'))
                                        <x-shop::button
                                            ...
                                            :title="trans('cliqnshop::app.products.view.buy-now')"
                                            :disabled="! $product->isSaleable(1)"
                                ...
                                <div class="mt-10 flex gap-9 max-md:mt-4 max-md:flex-wrap max-sm:justify-center max-sm:gap-3">
                                    ...
                                    >
                                        @if (core()->getConfigData('catalog.products.settings.compare_option'))
                                            ...
                                            @lang('cliqnshop::app.products.view.compare')
                                        @endif
                                    </div>
            ...
            app.component('v-product', {
                ...
                methods: {
                    addToCart(params) {
                        ...
                        this.$axios.post('{{ route("cliqnshop.api.checkout.cart.store") }}', formData, {
                                headers: {
                    ...
                    addToWishlist() {
                        if (this.isCustomer) {
                            this.$axios.post('{{ route('cliqnshop.api.customers.account.wishlist.store') }}', {
                            ...
                            window.location.href = "{{ route('cliqnshop.customer.session.index')}}";
                        }
                    },
                    ...
                    addToCompare(productId) {
                         ...
                         */
                        if (this.isCustomer) {
                            this.$axios.post('{{ route("cliqnshop.api.compare.store") }}', {
                        ...
                        if (existingItems.length) {
                            if (! existingItems.includes(productId)) {
                                ...
                                this.$emitter.emit('add-flash', { type: 'success', message: "@lang('cliqnshop::app.products.view.add-to-compare')" });
                            } else {
                                this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('cliqnshop::app.products.view.already-in-compare')" });
                            }
                        } else {
                    ...
                    updateQty(quantity, id) {
                        ...
                        this.$axios.put('{{ route('cliqnshop.api.checkout.cart.update') }}', { qty })
                            .then(response => {
                                if (response.data.message) {
