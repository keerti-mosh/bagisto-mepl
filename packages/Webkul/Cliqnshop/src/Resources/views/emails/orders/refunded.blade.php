@component('cliqnshop::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            @lang('cliqnshop::app.emails.orders.refunded.title')
        </span> <br>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('cliqnshop::app.emails.dear', ['customer_name' => $refund->order->customer_full_name]),👋
        </p>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('cliqnshop::app.emails.orders.refunded.greeting', [
                'invoice_id' => $refund->increment_id,
                'order_id'   => '<a href="' . route('cliqnshop.customers.account.orders.view', $refund->order_id) . '" style="color: #2969FF;">#' . $refund->order->increment_id . '</a>',
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        @lang('cliqnshop::app.emails.orders.refunded.summary')
    </div>
        ...
        @if ($refund->order->shipping_address)
            <div style="line-height: 25px;">
                ...
                <div style="font-size: 16px;font-weight: 400;color: #384860;margin-bottom: 40px;">
                    ...
                    @lang('cliqnshop::app.emails.orders.contact') : {{ $refund->order->billing_address->phone }}
                </div>
