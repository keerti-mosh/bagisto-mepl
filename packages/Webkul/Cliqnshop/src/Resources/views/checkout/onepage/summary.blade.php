...
<h1 class="text-2xl font-medium max-md:py-4 max-md:text-base">
    @lang('cliqnshop::app.checkout.onepage.summary.cart-summary')
</h1>
        ...
        <div>
            ...
            <p class="mt-2.5 flex flex-col text-lg font-medium max-md:mt-1 max-md:text-base max-md:font-normal max-sm:text-sm">
                <template v-if="displayTax.prices == 'including_tax'">
                    @lang('cliqnshop::app.checkout.onepage.summary.price_&_qty', ['price' => '@{{ item.formatted_price_incl_tax }}', 'qty' => '@{{ item.quantity }}'])
                </template>
                ...
                <template v-else-if="displayTax.prices == 'both'">
                    ...
                    <span class="text-xs font-normal">
                        @lang('cliqnshop::app.checkout.onepage.summary.excl-tax')
                ...
                <template v-else>
                    @lang('cliqnshop::app.checkout.onepage.summary.price_&_qty', ['price' => '@{{ item.formatted_price }}', 'qty' => '@{{ item.quantity }}'])
                </template>
            </p>
        </div>
    </div>
...
<div class="mb-8 mt-6 grid gap-4 max-md:mb-0 max-sm:mt-4 max-sm:gap-2.5">
    ...
    <template v-if="displayTax.subtotal == 'including_tax'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm">
                @lang('cliqnshop::app.checkout.onepage.summary.sub-total')
            </p>
    ...
    <template v-else-if="displayTax.subtotal == 'both'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm">
                @lang('cliqnshop::app.checkout.onepage.summary.sub-total-excl-tax')
            </p>
        ...
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm">
                @lang('cliqnshop::app.checkout.onepage.summary.sub-total-incl-tax')
            </p>
    ...
    >
        <p class="text-base max-sm:text-sm">
            @lang('cliqnshop::app.checkout.onepage.summary.discount-amount')
        </p>
    ...
    @include('cliqnshop::checkout.coupon')
    ...
    <template v-if="displayTax.shipping == 'including_tax'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm">
                @lang('cliqnshop::app.checkout.onepage.summary.delivery-charges')
            </p>
    ...
    <template v-else-if="displayTax.shipping == 'both'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm">
                @lang('cliqnshop::app.checkout.onepage.summary.delivery-charges-excl-tax')
            </p>
        ...
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm">
                @lang('cliqnshop::app.checkout.onepage.summary.delivery-charges-incl-tax')
            </p>
    ...
    >
        <p class="text-base max-md:font-normal max-sm:text-sm">
            @lang('cliqnshop::app.checkout.onepage.summary.tax')
        </p>
    ...
    <div class="flex justify-between text-right">
        <p class="text-lg font-semibold max-sm:text-sm">
            @lang('cliqnshop::app.checkout.onepage.summary.grand-total')
        </p>
