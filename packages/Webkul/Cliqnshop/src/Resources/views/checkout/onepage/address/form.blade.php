@pushOnce('scripts')
        ...
        <div class="mt-2 max-md:mt-3">
            ...
            <x-shop::form.control-group>
                <x-shop::form.control-group.label>
                    @lang('cliqnshop::app.checkout.onepage.address.company-name')
                </x-shop::form.control-group.label>
                ...
                <x-shop::form.control-group.control
                    ...
                    :placeholder="trans('cliqnshop::app.checkout.onepage.address.company-name')"
                />
            </x-shop::form.control-group>
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required !mt-0">
                        @lang('cliqnshop::app.checkout.onepage.address.first-name')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        rules="required"
                        :label="trans('cliqnshop::app.checkout.onepage.address.first-name')"
                        :placeholder="trans('cliqnshop::app.checkout.onepage.address.first-name')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required !mt-0">
                        @lang('cliqnshop::app.checkout.onepage.address.last-name')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        rules="required"
                        :label="trans('cliqnshop::app.checkout.onepage.address.last-name')"
                        :placeholder="trans('cliqnshop::app.checkout.onepage.address.last-name')"
                    />
            ...
            <x-shop::form.control-group>
                <x-shop::form.control-group.label class="required !mt-0">
                    @lang('cliqnshop::app.checkout.onepage.address.email')
                </x-shop::form.control-group.label>
                ...
                <x-shop::form.control-group.control
                    ...
                    :label="trans('cliqnshop::app.checkout.onepage.address.email')"
            ...
            <template v-if="controlName=='billing'">
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label>
                        @lang('cliqnshop::app.checkout.onepage.address.vat-id')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.checkout.onepage.address.vat-id')"
                        :placeholder="trans('cliqnshop::app.checkout.onepage.address.vat-id')"
                    />
            ...
            <x-shop::form.control-group>
                <x-shop::form.control-group.label class="required !mt-0">
                    @lang('cliqnshop::app.checkout.onepage.address.street-address')
                </x-shop::form.control-group.label>
                ...
                <x-shop::form.control-group.control
                    ...
                    :label="trans('cliqnshop::app.checkout.onepage.address.street-address')"
                    :placeholder="trans('cliqnshop::app.checkout.onepage.address.street-address')"
                />
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                <x-shop::form.control-group class="!mb-4">
                    <x-shop::form.control-group.label class="{{ core()->isCountryRequired() ? 'required' : '' }} !mt-0">
                        @lang('cliqnshop::app.checkout.onepage.address.country')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.checkout.onepage.address.country')"
                        :placeholder="trans('cliqnshop::app.checkout.onepage.address.country')"
                    >
                        <option value="">
                            @lang('cliqnshop::app.checkout.onepage.address.select-country')
                        </option>
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="{{ core()->isStateRequired() ? 'required' : '' }} !mt-0">
                        @lang('cliqnshop::app.checkout.onepage.address.state')
                    </x-shop::form.control-group.label>
                    ...
                    <template v-if="states">
                        <template v-if="haveStates">
                            <x-shop::form.control-group.control
                                ...
                                ::value="address.state"
                                :label="trans('cliqnshop::app.checkout.onepage.address.state')"
                                :placeholder="trans('cliqnshop::app.checkout.onepage.address.state')"
                            >
                                <option value="">
                                    @lang('cliqnshop::app.checkout.onepage.address.select-state')
                                </option>
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required !mt-0">
                        @lang('cliqnshop::app.checkout.onepage.address.city')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        ::value="address.city"
                        rules="required"
                        :label="trans('cliqnshop::app.checkout.onepage.address.city')"
                        :placeholder="trans('cliqnshop::app.checkout.onepage.address.city')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="{{ core()->isPostCodeRequired() ? 'required' : '' }} !mt-0">
                        @lang('cliqnshop::app.checkout.onepage.address.postcode')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.checkout.onepage.address.postcode')"
                        :placeholder="trans('cliqnshop::app.checkout.onepage.address.postcode')"
                    />
            ...
            <x-shop::form.control-group>
                <x-shop::form.control-group.label class="required !mt-0">
                    @lang('cliqnshop::app.checkout.onepage.address.telephone')
                </x-shop::form.control-group.label>
                ...
                <x-shop::form.control-group.control
                    ...
                    :label="trans('cliqnshop::app.checkout.onepage.address.telephone')"
                    :placeholder="trans('cliqnshop::app.checkout.onepage.address.telephone')"
                />
    ...
    <script type="module">
        app.component('v-checkout-address-form', {
            ...
            methods: {
                getCountries() {
                    this.$axios.get("{{ route('cliqnshop.api.core.countries') }}")
                        .then(response => {
                ...
                getStates() {
                    this.$axios.get("{{ route('cliqnshop.api.core.states') }}")
                        .then(response => {
