                    ...
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="mb-4 flex items-center justify-between max-md:mb-2">
                            <h2 class="text-xl font-medium max-sm:text-base max-sm:font-normal">
                                @lang('cliqnshop::app.checkout.onepage.address.billing-address')
                            </h2>
                        </div>
                        ...
                        <div class="mb-2 grid grid-cols-2 gap-5 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-md:mt-2 max-md:grid-cols-1">
                                ...
                                <div class="absolute top-5 flex gap-2 ltr:right-5 rtl:left-5">
                                    <x-shop::form.control-group class="!mb-0 flex items-center gap-2.5">
                                        <x-shop::form.control-group.control
                                            ...
                                            rules="required"
                                            label="{{ trans('cliqnshop::app.checkout.onepage.address.billing-address') }}"
                                        />
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p class="text-base">@lang('cliqnshop::app.checkout.onepage.address.add-new-address')</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <template v-if="cart.have_stockable_items">
                            ...
                            <x-shop::form.control-group class="!mb-0 mt-5 flex items-center gap-2.5">
                                ...
                                <label
                                    ...
                                    for="use_for_shipping"
                                >
                                    @lang('cliqnshop::app.checkout.onepage.address.same-as-billing')
                                </label>
                            </x-shop::form.control-group>
                            ...
                            >
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    <h2 class="text-xl font-medium max-md:text-lg max-sm:text-base">
                                        @lang('cliqnshop::app.checkout.onepage.address.shipping-address')
                                    </h2>
                                </div>
                                        ...
                                        <div class="absolute top-5 flex gap-5 ltr:right-5 rtl:left-5">
                                            <x-shop::form.control-group class="!mb-0 flex items-center gap-2.5">
                                                <x-shop::form.control-group.control
                                                    ...
                                                    rules="required"
                                                    label="{{ trans('cliqnshop::app.checkout.onepage.address.shipping-address') }}"
                                                />
                                            </x-shop::form.control-group>
                        ...
                        <div class="mt-4 flex justify-end max-md:my-4">
                            <x-shop::button
                                ...
                                :title="trans('cliqnshop::app.checkout.onepage.address.proceed')"
                                ::loading="isStoring"
                                ::disabled="isStoring"
                            />
                        </div>
                    ...
                    <form @submit="handleSubmit($event, updateOrCreateAddress)">
                        ...
                        <div class="mb-4 flex items-center justify-between">
                            ...
                            >
                                ...
                                @lang('cliqnshop::app.checkout.onepage.address.back')
                            </span>
                        </div>
                        ...
                        <x-shop::form.control-group class="!mb-0 flex items-center gap-2.5">
                            ...
                            <label
                                ...
                                for="save_address"
                            >
                                @lang('cliqnshop::app.checkout.onepage.address.save-address')
                            </label>
                        </x-shop::form.control-group>
                        ...
                        <div class="mt-4 flex justify-end">
                            <x-shop::button
                                class="primary-button rounded-2xl px-11 py-3 max-md:rounded-lg max-sm:w-full max-sm:max-w-full max-sm:py-1.5"
                                :title="trans('cliqnshop::app.checkout.onepage.address.save')"
                                ::loading="isStoring"
                                ::disabled="isStoring"
                            />
                        </div>
        ...
        app.component('v-checkout-address-customer', {
            ...
            methods: {
                getCustomerSavedAddresses() {
                    this.$axios.get('{{ route('cliqnshop.api.customers.account.addresses.index') }}')
                        .then(response => {
                ...
                createCustomerAddress(params, { setErrors }) {
                    ...
                    return this.$axios.post('{{ route('cliqnshop.api.customers.account.addresses.store') }}', params)
                        .then((response) => {
                ...
                updateCustomerAddress(id, params, { setErrors }) {
                    ...
                    return this.$axios.put('{{ route('cliqnshop.api.customers.account.addresses.update') }}/' + id, params)
                        .then((response) => {
                            this.isStoring = false;
                ...
                addAddressToCart(params, { setErrors }) {
                    ...
                    this.$axios.post('{{ route('cliqnshop.checkout.onepage.addresses.store') }}', payload)
                        .then((response) => {
                            this.isStoring = false;
