    ...
    >
        <div class="flex justify-between text-right">
            <p class="text-base max-md:font-normal max-sm:text-sm">
                @{{ cart.coupon_code ? "@lang('cliqnshop::app.checkout.coupon.applied')" : "@lang('cliqnshop::app.checkout.coupon.discount')" }}
            </p>
            ...
            <p class="text-base font-medium max-sm:text-sm">
                    ...
                    <form @submit="handleSubmit($event, applyCoupon)">
                        ...
                        <x-shop::modal ref="couponModel">
                            ...
                            <x-slot:toggle>
                                ...
                                >
                                    @lang('cliqnshop::app.checkout.coupon.apply')
                                </span>
                            </x-slot>
                            ...
                            <x-slot:content class="!px-4">
                                <x-shop::form.control-group class="!mb-0">
                                    <x-shop::form.control-group.control
                                        ...
                                        name="code"
                                        rules="required"
                                        :placeholder="trans('cliqnshop::app.checkout.coupon.enter-your-code')"
                                    />
                                ...
                                <div class="flex flex-wrap items-center gap-4 max-md:justify-between">
                                    <div class="flex items-center gap-4 max-md:block">
                                        <p class="text-sm font-medium text-zinc-500 max-md:text-left max-md:text-xs">
                                            @lang('cliqnshop::app.checkout.coupon.subtotal')
                                        </p>
                                    ...
                                    <x-shop::button
                                        ...
                                        :title="trans('cliqnshop::app.checkout.coupon.button-title')"
                                        ::loading="isStoring"
                                        ::disabled="isStoring"
                                    />
                                </div>
                ...
                >
                    <p
                        ...
                        title="@lang('cliqnshop::app.checkout.coupon.applied')"
                    >
                        "@{{ cart.coupon_code }}"
                    </p>
                    ...
                    <span
                        ...
                        title="@lang('cliqnshop::app.checkout.coupon.remove')"
                        @click="destroyCoupon"
                    >
                    </span>
                </div>
        ...
        app.component('v-coupon', {
            ...
            methods: {
                applyCoupon(params, { resetForm }) {
                    ...
                    this.$axios.post("{{ route('cliqnshop.api.checkout.cart.coupon.apply') }}", params)
                        .then((response) => {
                ...
                destroyCoupon() {
                    this.$axios.delete("{{ route('cliqnshop.api.checkout.cart.coupon.remove') }}", {
                            '_token': "{{ csrf_token() }}"
                        })
                        .then((response) => {
