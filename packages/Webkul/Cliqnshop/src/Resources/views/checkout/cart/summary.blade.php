<div class="w-[418px] max-w-full max-md:w-full">
    ...
    <p
        ...
        aria-level="1"
    >
        @lang('cliqnshop::app.checkout.cart.summary.cart-summary')
    </p>
    ...
    <div class="mt-6 grid gap-4 max-md:mt-2 max-md:gap-2.5">
        ...
        @if (core()->getConfigData('sales.checkout.shopping_cart.estimate_shipping'))
            <template v-if="cart.have_stockable_items">
                @include('cliqnshop::checkout.cart.summary.estimate-shipping')
            </template>
        @endif
        ...
        <template v-if="displayTax.subtotal == 'including_tax'">
            <div class="flex justify-between text-right">
                <p class="text-base max-sm:text-sm">
                    @lang('cliqnshop::app.checkout.cart.summary.sub-total')
                </p>
        ...
        <template v-else-if="displayTax.subtotal == 'both'">
            <div class="flex justify-between text-right">
                <p class="text-base max-sm:text-sm">
                    @lang('cliqnshop::app.checkout.cart.summary.sub-total-excl-tax')
                </p>
            ...
            <div class="flex justify-between text-right">
                <p class="text-base max-sm:text-sm">
                    @lang('cliqnshop::app.checkout.cart.summary.sub-total-incl-tax')
                </p>
        ...
        >
            <p class="text-base max-sm:text-sm">
                @lang('cliqnshop::app.checkout.cart.summary.discount-amount')
            </p>
        ...
        <template v-if="displayTax.shipping == 'including_tax'">
            <div class="flex justify-between text-right">
                <p class="text-base max-sm:text-sm">
                    @lang('cliqnshop::app.checkout.cart.summary.delivery-charges')
                </p>
        ...
        <template v-else-if="displayTax.shipping == 'both'">
            <div class="flex justify-between text-right">
                <p class="text-base max-sm:text-sm">
                    @lang('cliqnshop::app.checkout.cart.summary.delivery-charges-excl-tax')
                </p>
            ...
            <div class="flex justify-between text-right">
                <p class="text-base max-sm:text-sm">
                    @lang('cliqnshop::app.checkout.cart.summary.delivery-charges-incl-tax')
                </p>
        ...
        >
            <p class="text-base max-md:font-normal max-sm:text-sm">
                @lang('cliqnshop::app.checkout.cart.summary.tax')
            </p>
        ...
        <div class="flex justify-between text-right">
            <p class="text-lg font-semibold max-md:text-base">
                @lang('cliqnshop::app.checkout.cart.summary.grand-total')
            </p>
        ...
        >
            @lang('cliqnshop::app.checkout.cart.summary.proceed-to-checkout')
        </a>
