...
<v-mini-cart>
    <span
        ...
        role="button"
        aria-label="@lang('cliqnshop::app.checkout.cart.mini-cart.shopping-cart')"
    ></span>
</v-mini-cart>
...
@pushOnce('scripts')
    ...
    >
                ...
                <x-slot:header>
                    ...
                    <div class="flex items-center justify-between">
                        <p class="text-2xl font-medium max-md:text-xl max-sm:text-xl">
                            @lang('cliqnshop::app.checkout.cart.mini-cart.shopping-cart')
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <div class="grid flex-1 place-content-start justify-stretch gap-y-2.5">
                            <div class="flex justify-between gap-2 max-md:gap-0 max-sm:flex-wrap">
                                    ...
                                    :href="`{{ route('cliqnshop.product_or_category.index', '') }}/${item.product_url_key}`"
                                >
                                    ...
                                    <template v-else-if="displayTax.prices == 'both'">
                                        <p class="flex flex-col text-lg max-md:font-semibold max-sm:text-sm">
                                            ...
                                            <span class="text-xs font-normal text-zinc-500">
                                                @lang('cliqnshop::app.checkout.cart.mini-cart.excl-tax')
                                ...
                                >
                                    ...
                                    <div class="">
                                        ...
                                        >
                                            @lang('cliqnshop::app.checkout.cart.mini-cart.see-details')
                                ...
                                >
                                    @lang('cliqnshop::app.checkout.cart.mini-cart.remove')
                                </button>
                    ...
                    >
                        <div class="b-0 grid place-items-center gap-y-5 max-md:gap-y-0">
                            ...
                            <p
                                ...
                                role="heading"
                            >
                                @lang('cliqnshop::app.checkout.cart.mini-cart.empty-cart')
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <template v-if="! isLoading">
                            <p class="text-sm font-medium text-zinc-500">
                                @lang('cliqnshop::app.checkout.cart.mini-cart.subtotal')
                            </p>
                        ...
                        <a
                            href="{{ route('cliqnshop.checkout.onepage.index') }}"
                        ...
                        >
                            @lang('cliqnshop::app.checkout.cart.mini-cart.continue-to-checkout')
                        </a>
                            ...
                            <div class="block cursor-pointer text-center text-base font-medium max-md:py-1.5">
                                <a href="{{ route('cliqnshop.checkout.cart.index') }}">
                                    @lang('cliqnshop::app.checkout.cart.mini-cart.view-cart')
                                </a>
                            </div>
                        </div>
        ...
        @else
            <a href="{{ route('cliqnshop.checkout.onepage.index') }}">
                {!! view_render_event('bagisto.shop.checkout.mini-cart.drawer.toggle.before') !!}
