...
<v-checkout-login>
    <div class="flex items-center">
        <span class="cursor-pointer text-base font-medium text-blue-700">
            @lang('cliqnshop::app.checkout.login.title')
        </span>
    </div>
</v-checkout-login>
                        ...
                        <x-slot:content>
                            ...
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">
                                    @lang('cliqnshop::app.checkout.login.email')
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    :label="trans('cliqnshop::app.checkout.login.email')"
                                    placeholder="email@example.com"
                                    :aria-label="trans('cliqnshop::app.checkout.login.email')"
                                    aria-required="true"
                                />
                            ...
                            <x-shop::form.control-group class="!mb-0">
                                <x-shop::form.control-group.label class="required">
                                    @lang('cliqnshop::app.checkout.login.password')
                                </x-shop::form.control-group.label>
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    :label="trans('cliqnshop::app.checkout.login.password')"
                                    :placeholder="trans('cliqnshop::app.checkout.login.password')"
                                    :aria-label="trans('cliqnshop::app.checkout.login.password')"
                                    aria-required="true"
                                />
                        ...
                        <x-slot:footer>
                            <div class="flex flex-wrap items-center gap-4">
                                <x-shop::button
                                    ...
                                    :title="trans('cliqnshop::app.checkout.login.title')"
                                    ::loading="isStoring"
                                    ::disabled="isStoring"
                                />
                            </div>
        ...
        app.component('v-checkout-login', {
            ...
            methods: {
                login(params, { resetForm }) {
                    ...
                    this.$axios.post("{{ route('cliqnshop.api.customers.session.create') }}", params)
                        .then((response) => {
