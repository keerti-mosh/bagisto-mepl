<!-- SEO Meta Content -->
@push('meta')
    <meta name="description" content="@lang('cliqnshop::app.customers.forgot-password.title')"/>

    <meta name="keywords" content="@lang('cliqnshop::app.customers.forgot-password.title')"/>
@endPush
...
>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.customers.forgot-password.title')
    </x-slot>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        ...
        <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
            <a
                ...
                aria-label="@lang('cliqnshop::app.customers.forgot-password.bagisto')"
            >
                <img
        ...
        >
            ...
            <p class="mt-4 text-xl text-zinc-500 max-sm:mt-0 max-sm:text-sm">
                @lang('cliqnshop::app.customers.forgot-password.forgot-password-text')
            </p>

            {!! view_render_event('bagisto.shop.customers.forget_password.before') !!}

            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop::form :action="route('cliqnshop.customers.forgot_password.store')">
                    ...
                    <div class="mt-8 flex flex-wrap items-center gap-9 max-sm:mt-0 max-sm:justify-center max-sm:text-center">
                        <button
                            ...
                            type="submit"
                        >
                            @lang('cliqnshop::app.customers.forgot-password.submit')
                        </button>
                    </div>

                    <p class="mt-5 font-medium text-zinc-500 max-sm:text-center max-sm:text-sm">
                        @lang('cliqnshop::app.customers.forgot-password.back')

                        <a class="text-navyBlue"
                            href="{{ route('cliqnshop.customer.session.index') }}"
                        >
                            @lang('cliqnshop::app.customers.forgot-password.sign-in-button')
                        </a>
                    </p>
        ...
        <p class="mb-4 mt-8 text-center text-xs text-zinc-500">
            @lang('cliqnshop::app.customers.forgot-password.footer', ['current_year'=> date('Y') ])
        </p>
    </div>
