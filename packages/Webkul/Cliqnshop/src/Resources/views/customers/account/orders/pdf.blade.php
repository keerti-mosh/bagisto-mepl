    ...
    <body dir="{{ core()->getCurrentLocale()->direction }}">
        ...
        <div class="page">
            ...
            <div class="page-header">
                <b>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.invoice')</b>
            </div>
                ...
                <table class="{{ core()->getCurrentLocale()->direction }}">
                    <tbody>
                        <tr>
                            @if (core()->getConfigData('sales.invoice_settings.pdf_print_outs.invoice_id'))
                                <td style="width: 50%; padding: 2px 18px;border:none;">
                                    <b>
                                        @lang('cliqnshop::app.customers.account.orders.invoice-pdf.invoice-id'):
                                    </b>
                            ...
                            @if (core()->getConfigData('sales.invoice_settings.pdf_print_outs.order_id'))
                                <td style="width: 50%; padding: 2px 18px;border:none;">
                                    <b>
                                        @lang('cliqnshop::app.customers.account.orders.invoice-pdf.order-id'):
                                    </b>
                        ...
                        <tr>
                            <td style="width: 50%; padding: 2px 18px;border:none;">
                                <b>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.date'):
                                </b>
                            ...
                            <td style="width: 50%; padding: 2px 18px;border:none;">
                                <b>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.order-date'):
                                </b>
                            ...
                            <td style="width: 50%; padding: 2px 18px;border:none;">
                                @if ($invoice->hasPaymentTerm())
                                    <div style="margin-bottom: 12px">
                                        <b style="display: inline-block; margin-bottom: 4px;">
                                            @lang('cliqnshop::app.customers.account.orders.invoice-pdf.payment-terms'):
                                        </b>
                                ...
                                @if (core()->getConfigData('sales.shipping.origin.bank_details'))
                                    <div>
                                        <b style="display: inline-block; margin-bottom: 4px;">
                                            @lang('cliqnshop::app.customers.account.orders.invoice-pdf.bank-details'):
                                        </b>
                    ...
                    <thead>
                        <tr>
                            @if ($invoice->order->billing_address)
                                <th style="width: 50%;">
                                    <b>
                                        @lang('cliqnshop::app.customers.account.orders.invoice-pdf.bill-to')
                                    </b>
                                </th>
                            @endif
                            ...
                            @if ($invoice->order->shipping_address)
                                <th style="width: 50%">
                                    <b>
                                        @lang('cliqnshop::app.customers.account.orders.invoice-pdf.ship-to')
                                    </b>
                                </th>
                            @endif
                        </tr>
                        ...
                        <tr>
                            @if ($invoice->order->billing_address)
                                <td style="width: 50%">
                                    ...
                                    <div>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.contact'): {{ $invoice->order->billing_address->phone }}</div>
                                </td>
                            @endif
                            ...
                            @if ($invoice->order->shipping_address)
                                <td style="width: 50%">
                                    ...
                                    <div>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.contact'): {{ $invoice->order->shipping_address->phone }}</div>
                                </td>
                            @endif
                        </tr>
                    </tbody>
                ...
                <table class="{{ core()->getCurrentLocale()->direction }}">
                    <thead>
                        <tr>
                            <th style="width: 50%">
                                <b>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.payment-method')
                                </b>
                            </th>
                            ...
                            @if ($invoice->order->shipping_address)
                                <th style="width: 50%">
                                    <b>
                                        @lang('cliqnshop::app.customers.account.orders.invoice-pdf.shipping-method')
                                    </b>
                                </th>
                            @endif
                        </tr>
                ...
                <div class="items">
                    <table class="{{ core()->getCurrentLocale()->direction }}">
                        <thead>
                            <tr>
                                <th>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.sku')
                                </th>

                                <th>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.product-name')
                                </th>

                                <th>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.price')
                                </th>

                                <th>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.qty')
                                </th>

                                <th>
                                    @lang('cliqnshop::app.customers.account.orders.invoice-pdf.subtotal')
                                </th>
                            </tr>
                        </thead>
                                    ...
                                    <td>
                                        ...
                                        @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                            ...
                                            <div class="small-text">
                                                @lang('cliqnshop::app.customers.account.orders.invoice-pdf.excl-tax')
                ...
                <div class="summary">
                    <table class="{{ core()->getCurrentLocale()->direction }}">
                        <tbody>
                            @if (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'including_tax')
                                <tr>
                                    <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.subtotal')</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->base_sub_total_incl_tax, true) !!}</td>
                                </tr>
                            @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                <tr>
                                    <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.subtotal-incl-tax')</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->base_sub_total_incl_tax, true) !!}</td>
                                </tr>

                                <tr>
                                    <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.subtotal-excl-tax')</td>
                                    <td>-</td>
                            ...
                            @if (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'including_tax')
                                <tr>
                                    <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.shipping-handling')</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->base_shipping_amount_incl_tax, true) !!}</td>
                                </tr>
                            @elseif (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                                <tr>
                                    <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.shipping-handling-incl-tax')</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->base_shipping_amount_incl_tax, true) !!}</td>
                                </tr>

                                <tr>
                                    <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.shipping-handling-excl-tax')</td>
                                    <td>-</td>
                            ...
                            <tr>
                                <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.tax')</td>
                                <td>-</td>
                                <td>{!! core()->formatBasePrice($invoice->base_tax_amount, true) !!}</td>
                            </tr>

                            <tr>
                                <td>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.discount')</td>
                                <td>-</td>
                            ...
                            <tr>
                                <td style="border-top: 1px solid #FFFFFF;">
                                    <b>@lang('cliqnshop::app.customers.account.orders.invoice-pdf.grand-total')</b>
                                </td>
