<x-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.customers.account.orders.title')
    </x-slot>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        <!-- For Desktop View -->
        <div class="max-md:hidden">
            <x-shop::datagrid :src="route('cliqnshop.customers.account.orders.index')" />
        </div>
                                ...
                                <a :href="record.actions[0].url">
                                    <div class="flex justify-between">
                                        <div class="text-sm font-semibold">
                                            @lang('cliqnshop::app.customers.account.orders.order-id'): #@{{ record.id }}
                                    ...
                                    <div class="mt-2.5 text-xs font-normal text-neutral-500">
                                        @lang('cliqnshop::app.customers.account.orders.subtotal')
