<x-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.customers.account.addresses.edit.edit')
        @lang('cliqnshop::app.customers.account.addresses.edit.title')
    </x-slot>
    ...
    @push('scripts')
        ...
        >
            ...
            <x-shop::form
                method="PUT"
                :action="route('cliqnshop.customers.account.addresses.update',  $address->id)"
            >
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label>
                        @lang('cliqnshop::app.customers.account.addresses.edit.company-name')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.company-name')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.company-name')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required">
                        @lang('cliqnshop::app.customers.account.addresses.edit.first-name')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.first-name')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.first-name')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required">
                        @lang('cliqnshop::app.customers.account.addresses.edit.last-name')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.last-name')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.last-name')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label>
                        @lang('cliqnshop::app.customers.account.addresses.edit.vat-id')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.vat-id')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.vat-id')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required">
                        @lang('cliqnshop::app.customers.account.addresses.edit.street-address')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.street-address')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.street-address')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="{{ core()->isCountryRequired() ? 'required' : '' }}">
                        @lang('cliqnshop::app.customers.account.addresses.edit.country')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :aria-label="trans('cliqnshop::app.customers.account.addresses.edit.country')"
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.country')"
                    >
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="{{ core()->isStateRequired() ? 'required' : '' }}">
                        @lang('cliqnshop::app.customers.account.addresses.edit.state')
                    </x-shop::form.control-group.label>
                    <template v-if="haveStates()">
                        <x-shop::form.control-group.control
                            ...
                            :label="trans('cliqnshop::app.customers.account.addresses.edit.state')"
                            :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.state')"
                        >
                            <option
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required">
                        @lang('cliqnshop::app.customers.account.addresses.edit.city')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.city')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.city')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="{{ core()->isPostCodeRequired() ? 'required' : '' }}">
                        @lang('cliqnshop::app.customers.account.addresses.edit.post-code')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.post-code')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.post-code')"
                    />
                ...
                <x-shop::form.control-group>
                    <x-shop::form.control-group.label class="required">
                        @lang('cliqnshop::app.customers.account.addresses.edit.phone')
                    </x-shop::form.control-group.label>
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :label="trans('cliqnshop::app.customers.account.addresses.edit.phone')"
                        :placeholder="trans('cliqnshop::app.customers.account.addresses.edit.phone')"
                    />
                ...
                >
                    @lang('cliqnshop::app.customers.account.addresses.edit.update-btn')
                </button>
