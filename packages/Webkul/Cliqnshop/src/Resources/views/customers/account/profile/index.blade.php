<x-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.customers.account.profile.index.title')
    </x-slot>
        ...
        <div class="mt-8 grid grid-cols-1 gap-y-6 max-md:mt-5 max-sm:gap-y-4">
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('cliqnshop::app.customers.account.profile.index.first-name')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('cliqnshop::app.customers.account.profile.index.last-name')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('cliqnshop::app.customers.account.profile.index.gender')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('cliqnshop::app.customers.account.profile.index.dob')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('cliqnshop::app.customers.account.profile.index.email')
                </p>
            ...
            <x-shop::form action="{{ route('cliqnshop.customers.account.profile.destroy') }}">
                <x-shop::modal>
                    <x-slot:toggle>
                        <div class="primary-button rounded-2xl px-11 py-3 max-md:hidden max-md:rounded-lg">
                            @lang('cliqnshop::app.customers.account.profile.index.delete-profile')
                        </div>
                    ...
                    <x-slot:header>
                        <h2 class="text-2xl font-medium max-md:text-base">
                            @lang('cliqnshop::app.customers.account.profile.index.enter-password')
                        </h2>
                    </x-slot>
                    ...
                    <x-slot:footer>
                        ...
                        >
                            @lang('cliqnshop::app.customers.account.profile.index.delete')
                        </button>
                    </x-slot>
                </x-shop::modal>
            </x-shop::form>
