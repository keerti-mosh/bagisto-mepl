<x-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.customers.account.orders.view.page-title', ['order_id' => $order->increment_id])
    </x-slot>
        ...
        <div class="flex items-center justify-between">
            <div class="max-md:flex max-md:items-center">
                ...
                <a
                    ...
                    href="{{ route('cliqnshop.customers.account.orders.index') }}"
                >
            ...
            <div class="flex gap-1.5">
                ...
                @if (
                    ...
                    <a
                        href="{{ route('cliqnshop.customers.account.orders.reorder', $order->id) }}"
                        class="secondary-button border-zinc-200 px-5 py-3 font-normal max-md:hidden"
                    >
                        @lang('cliqnshop::app.customers.account.orders.view.reorder-btn-title')
                    </a>
                @endif
                ...
                @if ($order->canCancel())
                    <form
                        method="POST"
                        ref="cancelOrderForm"
                        action="{{ route('cliqnshop.customers.account.orders.cancel', $order->id) }}"
                    >
                        @csrf
                    </form>
                    ...
                    <a
                        ...
                        @click="$emitter.emit('open-confirm-modal', {
                            message: '@lang('cliqnshop::app.customers.account.orders.view.cancel-confirm-msg')',
                    ...
                    >
                        @lang('cliqnshop::app.customers.account.orders.view.cancel-btn-title')
                    </a>
                @endif
        ...
        <div class="mt-8 max-md:mt-5 max-md:grid max-md:gap-4">
            <x-shop::tabs>
                <x-shop::tabs.item
                    ...
                    :title="trans('cliqnshop::app.customers.account.orders.view.information.info')"
                    :is-selected="true"
                >
                    <!-- For Desktop -->
                    <div class="max-md:hidden">
                        <div class="text-base font-medium">
                            @lang('cliqnshop::app.customers.account.orders.view.information.placed-on')
                            ...
                            <table class="w-full text-left">
                                <thead class="border-b border-zinc-200 bg-zinc-100 text-sm text-black">
                                    <tr class="[&>*]:font-medium [&>*]:px-6 [&>*]:py-4">
                                        <th scope="col">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.sku')
                                        </th>

                                        <th scope="col">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.product-name')
                                        </th>

                                        <th scope="col">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.price')
                                        </th>

                                        <th scope="col">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.item-status')
                                        </th>

                                        <th scope="col">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.subtotal')
                                        </th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    @foreach ($order->items as $item)
                                        <tr class="border-b bg-white align-top font-medium [&>*]:px-6 [&>*]:py-4">
                                            <td data-value="@lang('cliqnshop::app.customers.account.orders.view.information.sku')">
                                                {{ $item->getTypeInstance()->getOrderedItem($item)->sku }}
                                            </td>

                                            <td data-value="@lang('cliqnshop::app.customers.account.orders.view.information.product-name')">
                                                {{ $item->name }}
                                            ...
                                            <td
                                                class="flex flex-col"
                                                data-value="@lang('cliqnshop::app.customers.account.orders.view.information.price')"
                                            >
                                                ...
                                                @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                                    ...
                                                    <span class="whitespace-nowrap text-xs font-normal">
                                                        @lang('cliqnshop::app.customers.account.orders.view.information.excl-tax')
                                            ...
                                            <td data-value="@lang('cliqnshop::app.customers.account.orders.view.information.item-status')">
                                                @if($item->qty_ordered)
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.ordered-item', ['qty_ordered' => $item->qty_ordered])
                                                @endif

                                                @if($item->qty_invoiced)
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.invoiced-item', ['qty_invoiced' => $item->qty_invoiced])
                                                @endif

                                                @if($item->qty_shipped)
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.item-shipped', ['qty_shipped' => $item->qty_shipped])
                                                @endif

                                                @if($item->qty_refunded)
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.item-refunded', ['qty_refunded' => $item->qty_refunded])
                                                @endif

                                                @if($item->qty_canceled)
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.item-canceled', ['qty_canceled' => $item->qty_canceled])
                                                @endif
                                            </td>

                                            <td
                                                class="flex flex-col"
                                                data-value="@lang('cliqnshop::app.customers.account.orders.view.information.subtotal')"
                                            >
                                                @if (core()->getConfigData('sales.taxes.sales.display_prices') == 'including_tax')
                                ...
                                <div class="flex justify-end">
                                    <div class="grid max-w-max gap-2 text-sm">
                                        ...
                                        @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                            <div class="flex w-full justify-between gap-x-5">
                                                @lang('cliqnshop::app.customers.account.orders.view.information.subtotal-excl-tax')
                                            ...
                                            <div class="flex w-full justify-between gap-x-5">
                                                @lang('cliqnshop::app.customers.account.orders.view.information.subtotal-incl-tax')
                                        ...
                                        @if ($order->haveStockableItems())
                                            @if (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'including_tax')
                                                <div class="flex w-full justify-between gap-x-5">
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.shipping-handling')
                                            ...
                                            @elseif (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                                                <div class="flex w-full justify-between gap-x-5">
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.shipping-handling-excl-tax')
                                                ...
                                                <div class="flex w-full justify-between gap-x-5">
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.shipping-handling-incl-tax')
                                        ...
                                        <!-- Tax Amount -->
                                        <div class="flex w-full justify-between gap-x-5">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.tax')
                                        ...
                                        @if ($order->base_discount_amount > 0)
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p>
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.discount')
                                        ...
                                        <div class="flex w-full justify-between gap-x-5 font-semibold">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.grand-total')
                                        ...
                                        <!-- Total Paid -->
                                        <div class="flex w-full justify-between gap-x-5">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.total-paid')
                                        ...
                                        <!-- Total Refunded -->
                                        <div class="flex w-full justify-between gap-x-5">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.total-refunded')
                                        ...
                                        <!-- Total Due -->
                                        <div class="flex w-full justify-between gap-x-5">
                                            @lang('cliqnshop::app.customers.account.orders.view.information.total-due')
                    ...
                    <div class="grid gap-4 md:hidden">
                        <div class="rounded-lg border">
                            <div class="grid gap-1.5 px-4 py-2.5 text-xs font-medium text-zinc-500 [&>*]:flex [&>*]:justify-between">
                                <div>
                                    @lang('cliqnshop::app.customers.account.orders.view.order-id'):
                                ...
                                <div class="items-center">
                                    @lang('cliqnshop::app.customers.account.orders.view.status')
                        ...
                        >
                            <x-slot:header class="bg-gray-100 !px-4 py-3 text-sm font-medium max-sm:py-2">
                               @lang('cliqnshop::app.customers.account.orders.view.item-ordered')
                            </x-slot>
                                ...
                                @foreach ($order->items as $item)
                                    <div class="rounded-md rounded-t-none border border-t-0 bg-white px-4 py-2">
                                        ...
                                        <div class="grid gap-1.5 text-xs font-medium">
                                            ...
                                            <div class="flex justify-between">
                                                <span class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.invoices.subtotal'):
                                                </span>
                                                ...
                                                <span class="[&>*]:text-right">
                                                    ...
                                                    @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                                        ...
                                                        <p class="whitespace-nowrap text-xs font-normal">
                                                            @lang('cliqnshop::app.customers.account.orders.view.invoices.excl-tax')
                                            ...
                                            <div class="flex justify-between">
                                                <span class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.tax-percent')
                                                </span>
                                            ...
                                            <div class="flex justify-between">
                                                <span class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.information.tax-amount')
                                                </span>
                        ...
                        <div class="w-full rounded-md bg-gray-100">
                            <div class="rounded-t-md border-none !px-4 py-3 text-sm font-medium max-sm:py-2">
                                @lang('cliqnshop::app.customers.account.orders.view.information.order-summary')
                            </div>
                ...
                @if ($order->invoices->count())
                    <x-shop::tabs.item
                        ...
                        :title="trans('cliqnshop::app.customers.account.orders.view.invoices.invoices')"
                    >
                            ...
                            @foreach ($order->invoices as $invoice)
                                ...
                                <div class="grid gap-4 md:hidden">
                                    <div class="rounded-lg border">
                                        <div class="grid gap-1.5 px-4 py-2.5 text-xs font-medium text-zinc-500 [&>*]:flex [&>*]:justify-between">
                                            <div class="flex justify-between">
                                                @lang('cliqnshop::app.customers.account.orders.view.invoices.individual-invoice', ['invoice_id' => $invoice->increment_id ?? $invoice->id])

                                                <a href="{{ route('cliqnshop.customers.account.orders.print-invoice', $invoice->id) }}">
                                                    <div class="flex items-center gap-1 font-medium text-black">
                                                        <span class="icon-download text-sm font-semibold"></span>

                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.print')
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        <x-slot:header class="!mb-0 rounded-t-md bg-gray-100 !px-4 py-3 text-sm font-medium max-sm:py-2">
                                            @lang('cliqnshop::app.customers.account.orders.view.item-invoiced')
                                        </x-slot>
                                            ...
                                            @foreach ($invoice->items as $item)
                                                <div class="rounded-md rounded-t-none border border-t-0 bg-white px-4 py-2">
                                                    ...
                                                    <div class="grid gap-1.5 text-xs font-medium">
                                                        ...
                                                        <div class="flex justify-between">
                                                            <span class="text-zinc-500">
                                                                @lang('cliqnshop::app.customers.account.orders.view.invoices.sku'):
                                                            </span>
                                                        ...
                                                        <div class="flex justify-between">
                                                            <span class="text-zinc-500">
                                                                @lang('cliqnshop::app.customers.account.orders.view.invoices.price'):
                                                            </span>
                                                        ...
                                                        <div class="flex justify-between">
                                                            <span class="text-zinc-500">
                                                                @lang('cliqnshop::app.customers.account.orders.view.invoices.qty')
                                                            </span>
                                    ...
                                    <div class="w-full rounded-md bg-gray-100">
                                        ...
                                        <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                                            ...
                                            @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                                <div class="flex w-full justify-between gap-x-5">
                                                    <p class="text-zinc-500">
                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.subtotal-excl-tax')
                                                    </p>
                                            ...
                                            @elseif (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                                                <div class="flex w-full justify-between gap-x-5">
                                                    <p class="text-zinc-500">
                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.shipping-handling-excl-tax')
                                                    </p>
                                                ...
                                                <div class="flex w-full justify-between gap-x-5">
                                                    <p class="text-zinc-500">
                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.shipping-handling-incl-tax')
                                                    </p>
                                            ...
                                            @else
                                                <div class="flex w-full justify-between gap-x-5">
                                                    <p class="text-zinc-500">
                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.shipping-handling')
                                                    </p>
                                            ...
                                            @if ($invoice->base_discount_amount > 0)
                                                <div class="flex w-full justify-between gap-x-5">
                                                    <p class="text-zinc-500">
                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.discount')
                                                    </p>
                                            ...
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.invoices.tax')
                                                </p>
                                            ...
                                            <div class="flex w-full justify-between gap-x-5 font-semibold">
                                                <p class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.invoices.grand-total')
                                                </p>
                                        ...
                                        <table class="w-full text-left">
                                            <thead class="border-b border-zinc-200 bg-zinc-100 text-sm text-black">
                                                <tr class="[&>*]:font-medium [&>*]:px-6 [&>*]:py-4">
                                                    ...
                                                    <th scope="col">
                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.product-name')
                                                    </th>
                                            ...
                                            <tbody>
                                                @foreach ($invoice->items as $item)
                                                    <tr class="border-b bg-white text-black [&>*]:font-medium [&>*]:px-6 [&>*]:py-4">
                                                        <td data-value="@lang('cliqnshop::app.customers.account.orders.view.invoices.sku')">
                                                            {{ $item->getTypeInstance()->getOrderedItem($item)->sku }}
                                                        </td>

                                                        <td data-value="@lang('cliqnshop::app.customers.account.orders.view.invoices.product-name')">
                                                            {{ $item->name }}
                                                        ...
                                                        <td
                                                            class="flex flex-col"
                                                            data-value="@lang('cliqnshop::app.customers.account.orders.view.invoices.price')"
                                                        >
                                                            @if (core()->getConfigData('sales.taxes.sales.display_prices') == 'including_tax')
                                                                {{ core()->formatPrice($item->price_incl_tax, $order->order_currency_code) }}
                                                            @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                                        ...
                                                        <td data-value="@lang('cliqnshop::app.customers.account.orders.view.invoices.qty')">
                                                            {{ $item->qty }}
                                                        </td>

                                                        <td
                                                            class="flex flex-col"
                                                            data-value="@lang('cliqnshop::app.customers.account.orders.view.invoices.subtotal')"
                                                        >
                                                            @if (core()->getConfigData('sales.taxes.sales.display_prices') == 'including_tax')
                                                                {{ core()->formatPrice($item->total_incl_tax, $order->order_currency_code) }}
                                                            @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                        ...
                                        <div class="flex flex-auto justify-end">
                                            <div class="grid max-w-max gap-2 text-sm">
                                                ...
                                                @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                                    ...
                                                    <div class="flex w-full justify-between gap-x-5">
                                                        @lang('cliqnshop::app.customers.account.orders.view.invoices.subtotal-incl-tax')
                ...
                @if ($order->shipments->count())
                    <x-shop::tabs.item
                        ...
                        title="{{ trans('cliqnshop::app.customers.account.orders.view.shipments.shipments') }}"
                    >
                        <div class="flex flex-col gap-10 max-md:gap-8">
                            @foreach ($order->shipments as $shipment)
                                ...
                                <div class="max-md:hidden">
                                    <div>
                                        <label class="text-base font-medium">
                                            @lang('cliqnshop::app.customers.account.orders.view.shipments.tracking-number')
                                        </label>
                                    ...
                                    <div class="text-base font-medium">
                                        <span>
                                            @lang('cliqnshop::app.customers.account.orders.view.shipments.individual-shipment', ['shipment_id' => $shipment->id])
                                        </span>
                                    </div>
                                    ...
                                    <div class="relative mt-5 overflow-x-auto rounded-xl border max-md:hidden">
                                        <table class="w-full text-left text-sm">
                                            <thead class="border-b border-zinc-200 bg-zinc-100 text-sm text-black">
                                                <tr class="[&>*]:font-medium [&>*]:px-6 [&>*]:py-4">
                                                    <th scope="col">
                                                        @lang('cliqnshop::app.customers.account.orders.view.shipments.sku')
                                                    </th>

                                                    <th scope="col">
                                                        @lang('cliqnshop::app.customers.account.orders.view.shipments.product-name')
                                                    </th>

                                                    <th scope="col">
                                                        @lang('cliqnshop::app.customers.account.orders.view.shipments.qty')
                                                    </th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                @foreach ($shipment->items as $item)
                                                    <tr class="border-b bg-white [&>*]:font-medium [&>*]:px-6 [&>*]:py-4 [&>*]:text-black">
                                                        <td data-value="@lang('cliqnshop::app.customers.account.orders.view.shipments.sku')">
                                                            {{ $item->sku }}
                                                        </td>

                                                        <td data-value="@lang('cliqnshop::app.customers.account.orders.view.shipments.product-name')">
                                                            {{ $item->name }}
                                                        ...
                                                        <td data-value="@lang('cliqnshop::app.customers.account.orders.view.shipments.qty')">
                                                            {{ $item->qty }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                ...
                                <div class="grid gap-4 md:hidden">
                                    ...
                                    >
                                        <x-slot:header class="!mb-0 rounded-t-md bg-gray-100 !px-4 py-3 text-sm font-medium max-sm:py-2">
                                            @lang('cliqnshop::app.customers.account.orders.view.item-shipped')
                                        </x-slot>
                ...
                @if ($order->refunds->count())
                    <x-shop::tabs.item
                        class="max-md:!px-0 max-md:py-1.5"
                        :title="trans('cliqnshop::app.customers.account.orders.view.refunds.refunds')"
                    >
                        @foreach ($order->refunds as $refund)
                            ...
                            <div class="max-md:hidden">
                                <div class="text-base font-medium">
                                    <span>
                                        @lang('cliqnshop::app.customers.account.orders.view.refunds.individual-refund', ['refund_id' => $refund->id])
                                    </span>
                                </div>
                                ...
                                <div class="relative mt-8 overflow-x-auto rounded-xl border">
                                    <table class="w-full text-left text-sm">
                                        <thead class="border-b border-zinc-200 bg-zinc-100 text-sm text-black">
                                            <tr class="[&>*]:font-medium [&>*]:px-6 [&>*]:py-4">
                                                <th scope="col">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.sku')
                                                </th>

                                                <th scope="col">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.product-name')
                                                </th>

                                                <th scope="col">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.price')
                                                </th>

                                                <th scope="col">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.qty')
                                                </th>

                                                <th scope="col">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.subtotal')
                                                </th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            @foreach ($refund->items as $item)
                                                <tr class="border-b bg-white [&>*]:font-medium [&>*]:px-6 [&>*]:py-4 [&>*]:text-black">
                                                    <td data-value="@lang('cliqnshop::app.customers.account.orders.view.refunds.sku')">
                                                        {{ $item->child ? $item->child->sku : $item->sku }}
                                                    </td>

                                                    <td data-value="@lang('cliqnshop::app.customers.account.orders.view.refunds.product-name')">
                                                        {{ $item->name }}
                                                    ...
                                                    <td
                                                        class="flex flex-col"
                                                        data-value="@lang('cliqnshop::app.customers.account.orders.view.refunds.price')"
                                                    >
                                                        @if (core()->getConfigData('sales.taxes.sales.display_prices') == 'including_tax')
                                                            {{ core()->formatPrice($item->price_incl_tax, $order->order_currency_code) }}
                                                        @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                                    ...
                                                    <td data-value="@lang('cliqnshop::app.customers.account.orders.view.refunds.qty')">
                                                        {{ $item->qty }}
                                                    </td>

                                                    <td
                                                        class="flex flex-col"
                                                        data-value="@lang('cliqnshop::app.customers.account.orders.view.refunds.subtotal')"
                                                    >
                                                        @if (core()->getConfigData('sales.taxes.sales.display_prices') == 'including_tax')
                                                            {{ core()->formatPrice($item->total_incl_tax, $order->order_currency_code) }}
                                                        @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                            ...
                                            @if (! $refund->items->count())
                                                <tr>
                                                    <td>@lang('cliqnshop::app.customers.account.orders.view.refunds.no-result-found')</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
                            ...
                            <div class="grid gap-4 md:hidden">
                                ...
                                >
                                    <x-slot:header class="!mb-0 rounded-t-md bg-gray-100 !px-4 py-3 text-sm font-medium max-sm:py-2">
                                        @lang('cliqnshop::app.customers.account.orders.view.item-refunded')
                                    </x-slot>
                                ...
                                <div class="w-full rounded-md bg-gray-100">
                                    <div class="rounded-t-md border-none !px-4 py-3 text-sm font-medium max-sm:py-2">
                                        @lang('cliqnshop::app.customers.account.orders.view.refunds.order-summary')
                                    </div>
                                    ...
                                    <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                                        ...
                                        @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.subtotal-excl-tax')
                                                </p>
                                            ...
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p class="text-zinc-500">
                                                    ...
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.subtotal-incl-tax')
                                                </p>
                                        ...
                                        @if (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'including_tax')
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.shipping-handling')
                                                </p>
                                        ...
                                        @elseif (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.shipping-handling-excl-tax')
                                                </p>
                                            ...
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.shipping-handling-incl-tax')
                                                </p>
                                        ...
                                        @if ($refund->discount_amount > 0)
                                            <div class="flex w-full justify-between gap-x-5">
                                                @lang('cliqnshop::app.customers.account.orders.view.refunds.discount')
                                        ...
                                        @if ($refund->tax_amount > 0)
                                            <div class="flex w-full justify-between gap-x-5">
                                                <p class="text-zinc-500">
                                                    @lang('cliqnshop::app.customers.account.orders.view.refunds.tax')
                                                </p>
                                        ...
                                        <div class="flex w-full justify-between gap-x-5">
                                            <p class="text-zinc-500">
                                                @lang('cliqnshop::app.customers.account.orders.view.refunds.adjustment-refund')
                                            </p>
                                        ...
                                        <div class="flex w-full justify-between gap-x-5">
                                            <p class="text-zinc-500">
                                                @lang('cliqnshop::app.customers.account.orders.view.refunds.adjustment-fee')
                                            </p>
                                        ...
                                        <div class="flex w-full justify-between gap-x-5 font-semibold">
                                            <p class="text-zinc-500">
                                                @lang('cliqnshop::app.customers.account.orders.view.refunds.grand-total')
                                            </p>
            ...
            <div class="w-full rounded-md bg-gray-100 md:hidden">
                <div class="rounded-t-md border-none !px-4 py-3 text-sm font-medium max-sm:py-2">
                    @lang('cliqnshop::app.customers.account.orders.view.shipping-and-payment')
                </div>
                ...
                <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                    ...
                    @if ($order->shipping_address)
                        <div class="text-sm font-medium text-zinc-500">
                            @lang('cliqnshop::app.customers.account.orders.view.shipping-address')

                            <div class="mt-1 grid gap-2 text-xs text-black">
                                <div class="grid gap-2.5 max-md:gap-0">
                                    @include ('cliqnshop::customers.account.orders.view.address', ['address' => $order->shipping_address])
                                </div>
                    ...
                    @if ($order->billing_address)
                        <div class="text-sm font-medium text-zinc-500">
                            @lang('cliqnshop::app.customers.account.orders.view.billing-address')

                            <div class="mt-1 grid gap-2 text-xs text-gray-800">
                                <div class="grid gap-2.5 max-md:gap-0">
                                    @include ('cliqnshop::customers.account.orders.view.address', ['address' => $order->billing_address])
                                </div>
                    ...
                    @if ($order->shipping_address)
                        <div class="text-sm font-medium text-zinc-500">
                            @lang('cliqnshop::app.customers.account.orders.view.shipping-method')
                    ...
                    <!-- Payment Method -->
                    <div class="text-sm font-medium text-zinc-500">
                        @lang('cliqnshop::app.customers.account.orders.view.payment-method')
