<x-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('cliqnshop::app.customers.account.wishlist.page-title')
    </x-slot>
    ...
    @pushOnce('scripts')
            ...
            <div>
                ...
                <template v-else>
                    <div class="flex items-center justify-between">
                        ...
                        >
                            @lang('cliqnshop::app.customers.account.wishlist.delete-all')
                        </div>
                    ...
                    <template v-else>
                        <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                            ...
                            <p
                                ...
                                role="heading"
                            >
                                @lang('cliqnshop::app.customers.account.wishlist.empty')
                            </p>
                        </div>
                    </template>
                </template>
                        ...
                        <div class="flex justify-between gap-x-2.5 border-b border-zinc-200 pb-5">
                            <div class="flex gap-x-5 max-md:w-full max-md:gap-x-5">
                                <div>
                                    ...
                                    <a :href="`{{ route('cliqnshop.product_or_category.index', '') }}/${wishlist.product.url_key}`">
                                        <!-- Wishlist Item Image -->
                                        <img
                                ...
                                <div class="grid gap-y-2.5 max-md:w-full max-md:gap-y-0">
                                    ...
                                    >
                                        <div class="grid gap-2">
                                            <div>
                                                ...
                                                >
                                                    @lang('cliqnshop::app.customers.account.wishlist.see-details')
                                    ...
                                    <div class="max-md:block md:hidden">
                                        ...
                                        <a
                                            ...
                                            @click="remove"
                                        >
                                            @lang('cliqnshop::app.customers.account.wishlist.remove')
                                        </a>
                                    ...
                                    <div class="flex gap-5 max-md:mt-2.5">
                                        ...
                                        @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                            ...
                                            <x-shop::button
                                                ...
                                                :title="trans('cliqnshop::app.customers.account.wishlist.move-to-cart')"
        ...
        <script type="module">
            app.component("v-wishlist-products", {
                ...
                methods: {
                    get() {
                        this.$axios.get("{{ route('cliqnshop.api.customers.account.wishlist.index') }}")
                            .then(response => {
                    ...
                    removeAll() {
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                this.$axios.post("{{ route('cliqnshop.api.customers.account.wishlist.destroy_all') }}", {
                                        '_method': 'DELETE',
                                    })
                                    .then(response => {
                                        this.wishlistItems = [];
                ...
                methods: {
                    remove() {
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                this.$axios
                                    .delete(`{{ route('cliqnshop.api.customers.account.wishlist.destroy', '') }}/${this.wishlist.id}`)
                                    .then(response => {
                    ...
                    moveToCart() {
                        ...
                        const endpoint = `{{ route('cliqnshop.api.customers.account.wishlist.move_to_cart', ':wishlistId:') }}`.replace(':wishlistId:', this.wishlist.id);
